...
export const cervicalCancerCareSources: Record<
  string,
  CervicalCancerCareSource
> = {
  nccSymptoms: {
  ...
  nccSurvivorDistressAdaptation: {
    label: "국가암정보센터 암생존자 마음관리 - 변화된 삶에 적응하기",
    url: "https://www.cancer.go.kr/lay1/S1T788C790/contents.do",
  },
  nccMentalHealthStressCancerCause: {
    label: "국가암정보센터 암환자 정신건강 - 스트레스와 암 원인 오해",
    url: "https://www.cancer.go.kr/lay1/bbs/S1T668C805/G/54/view.do?article_seq=22076&condition=&cpage=4&keyword=&mode=view&rn=46&rows=12",
  },
  ...
  nccMentalHealthInsomniaMedicationConcern: {
    ...
    url: "https://www.cancer.go.kr/lay1/bbs/S1T668C805/G/54/view.do?article_seq=22078&condition=&cpage=2&keyword=&mode=view&rn=49&rows=12",
  },
  nccMentalHealthPsychiatryConsultBenefits: {
    label: "국가암정보센터 암환자 정신건강 - 정신건강의학과 진료 도움",
    url: "https://www.cancer.go.kr/lay1/bbs/S1T668C805/G/54/view.do?article_seq=22079&condition=&cpage=2&keyword=&mode=view&rn=48&rows=12",
  },
  nccSurvivorAnxietyManagement: {
    label: "국가암정보센터 암생존자 마음관리 - 내 안의 불안 다스리기",
    url: "https://www.cancer.go.kr/lay1/S1T788C791/contents.do",
  },
...
export const cervicalCancerCareAlerts: CervicalCancerCareAlert[] = [
  {
    title: "비정상 질출혈",
    detail:
      "폐경 후 새 출혈, 생리기간 외 출혈, 성관계 후 출혈, 갑자기 많아진 생리량을 구분해 기록합니다.",
  ...
  },
  {
    title: "분비물 변화",
    detail:
      "악취가 나는 분비물, 붉은 분비물, 갑자기 늘어난 분비물을 날짜별로 기록합니다.",
  ...
  },
  {
    title: "골반통·요통·다리 통증",
    detail:
      "심한 골반통, 허리통증, 다리로 뻗치는 통증이 새로 생기거나 악화되는지 봅니다.",
  ...
  },
  {
    title: "배뇨·배변 변화",
    detail:
      "배뇨곤란, 혈뇨, 직장출혈, 변비처럼 방광·직장 관련 변화가 있는지 확인합니다.",
...
export const cervicalCancerCarePrompts: CervicalCancerCarePrompt[] = [
  {
    topic: "자궁경부암 추적",
    question:
      "다음 추적 진료에서 자궁경부세포검사, HPV 검사, 내진, 영상검사 중 어떤 항목과 주기를 확인해야 하나요?",
    sourceId: "nccSymptoms",
  },
  {
    topic: "검진·진단검사 구분",
  ...
  },
  {
    topic: "치료 후 회복",
    question:
      "수술·방사선·항암 치료 후 피해야 할 활동, 부부관계 재개 시점, 운전/운동 제한을 제 상태 기준으로 어떻게 확인하면 좋을까요?",
  ...
  {
    topic: "디스트레스 신호·자가평가 상담 준비",
    question:
      "국가암정보센터 암생존자 마음관리의 변화된 삶에 적응하기 안내처럼 디스트레스는 암생존자의 몸과 마음에 나타나는 모든 괴로움이고 모든 암환자의 20~40%, 즉 10명 중 2명에서 4명이 겪을 수 있다고 설명됩니다. 다스리기 어려운 고통스러운 신체 증상, 외모에 원하지 않은 변화, 원래 있던 마음 문제 악화, 역할이나 관계 변화, 돌보아야 하는 아이, 부모님께 다시 도움을 받는 상황, 주변 사람들에게 암 이야기를 해야 하는 부담, 새로운 직장이나 복귀 후 기대와 실제 상태 차이, 암 관리에 대한 정보가 부족하거나 암 관리를 계속해야 한다는 부담을 어떻게 기록하면 좋을까요? 걱정, 두려움, 불안, 숨쉬기 답답하거나 긴장된 느낌, 우울함이나 의욕 저하, 짜증, 잠들기 어렵거나 잠에서 쉽게 깹니다, 사람들과 사이가 안 좋아지거나 혼자라는 느낌, 살고 싶지 않거나 죽고 싶다는 생각, 너무 적게 먹거나 한꺼번에 많이 먹음, 가치 없거나 쓸모없다는 느낌, 죽음에 관한 두려움을 진료팀과 보호자에게 어떤 긴급도와 문구로 공유하면 좋을까요? 자녀보육, 경제적 문제, 직장/학교, 우울/슬픔, 재발/죽음에 대한 불안, 식사, 피로, 기억력/집중력, 통증 같은 자가평가 항목에서 예가 많을수록 관심과 도움이 필요하다는 신호라는 점을 제 기록 양식에 어떻게 반영하면 좋을까요?",
    sourceId: "nccSurvivorDistressAdaptation",
  },
  {
    topic: "스트레스·암 원인 오해 상담 준비",
    question:
      "국가암정보센터 암환자 정신건강 인터뷰의 스트레스를 많이 받아서 암에 걸린 걸까요 안내처럼 암환자들은 흔히 누군가를 탓하고 싶은 마음이 들고, 특히 암이 스트레스 때문에 생겼다고 생각하면 스트레스를 불러일으킨 상황이나 사람을 탓하는 경향이 있다고 설명됩니다. 하지만 스트레스가 직접적인 발암인자, 암이 생기게 한 원인이라고 할 수는 없습니다라는 설명을 원인 단정이나 책임 전가로 쓰지 않으면서 제 마음속 원망, 죄책감, 가족·직장·돌봄 상황에서 반복되는 스트레스 이야기를 진료팀과 보호자에게 어떤 문장으로 공유하면 좋을까요? 스트레스가 암의 원인은 아닐지 몰라도 이미 암이 있는 환자에게는 면역력을 약화시켜 악성세포의 성장에 영향을 준다는 설명과, 일상생활에 스트레스를 받지 않고 살 수는 없으므로 스트레스를 피하는 것보다 건전한 스트레스 해소법으로 잘 관리하는 것이 중요하고 적당한 운동, 건강한 식생활, 좋은 대인관계, 건전한 신앙생활 등을 계속해 나가는 것이 좋다는 설명을 내 상태의 활동 가능 범위, 식사 어려움, 관계 부담, 믿음·가치관 지원, 상담 필요성 확인 질문으로 어떻게 정리하면 좋을까요?",
    sourceId: "nccMentalHealthStressCancerCause",
  },
  {
    topic: "치료 후 슬럼프·우울 상담 준비",
    question:
      "국가암정보센터 암환자 정신건강의 암치료 후 슬럼프 안내처럼 암 진단 후에 수술과 항암화학요법, 방사선치료를 마친 것은 초기 치료가 일단락된 상황으로 설명됩니다. 우울증은 암 진단 직후나 치료 중에 많이 생기지만 처음에는 멀쩡하다가 한참 후에 우울증이 나타나는 경우도 흔하다고 하므로, 치료가 끝난 뒤 눈물이 나거나 울적함, 의욕 저하, 좌절감, 절망감, 고립감, 고독감, 허무감이 언제부터 얼마나 지속되는지 어떻게 기록하면 좋을까요? 일차 치료가 끝난 뒤 혼자서 관리해야 한다는 부담감, 재발이나 전이에 대한 막연한 두려움, 치료 전후 생활 변화와 도움 요청이 어려운 상황을 진료팀과 보호자에게 어떤 문장으로 공유하면 좋을까요? 우울한 기분이나 의욕 상실이 한 달 이상 이어지거나 정도가 심할 때 정신건강의학과 상담과 항우울제 처방 필요 여부를 스스로 판단하지 않고 전문가의 도움 기준으로 확인하려면 어떤 질문을 준비하면 좋을까요?",
    sourceId: "nccSurvivorPostTreatmentSlump",
  },
  {
    topic: "불면증·정신과 약 중독 우려 상담 준비",
    question:
      "국가암정보센터 암환자 정신건강 인터뷰의 암 진단 후 불면증과 정신과 약 중독 우려 안내처럼 정신건강의학과에 대한 편견에는 약을 한 번 먹으면 끊지 못한다는 통념, 진료기록이 남으면 취직이나 보험에 불이익이 생긴다는 걱정이 포함된다고 설명됩니다. 이 때문에 도움이 필요한데도 적절한 서비스를 받지 못하는 환자가 많다는 점을 기준으로, 암 진단 후 잠을 잘 못 자는 기간, 우울·불안 동반 여부, 정신건강의학과 진료기록·보험·직장 걱정, 약을 끊지 못할까 하는 우려를 진료팀에 어떤 말로 공유하면 좋을까요? 가벼운 불면·우울·불안은 약 없이 상담만으로도 도움을 받을 수 있고, 수면제·항우울제·항불안제 등 정신약물요법이 필요한 경우에도 증상 조절 목적이며 대부분 단기간에 끊을 수 있다는 설명을 내 상태의 상담·처방 필요성, 기간, 부작용, 중단 계획, 주치의와 정신건강의학과 협진 질문으로 어떻게 확인하면 좋을까요?",
    sourceId: "nccMentalHealthInsomniaMedicationConcern",
  },
  {
    topic: "정신건강의학과 진료 도움 확인 준비",
    question:
      "국가암정보센터 암환자 정신건강 인터뷰의 암치료 중 정신건강의학과 진료 도움 안내처럼 암을 치료하는 주치의 선생님이 정신건강의학과 진료를 권했을 때, 암환자의 절반 가까이가 투병 중에 정신건강의학적인 문제를 갖게 될 수 있고 불면이나 우울, 불안 등의 증상이 심하거나 오래 지속되면 정신적 고통 때문에 정신신경 면역학적 기전을 통해 면역력이 떨어질 수 있다고 설명됩니다. 제 불면·우울·불안이 언제부터 얼마나 심하게 이어지는지, 항암·방사선·수술 일정과 겹치는지, 일상생활·식사·수면·치료 이해도에 어떤 영향을 주는지 진료팀에 어떻게 기록해 공유하면 좋을까요? 정신건강의학과 진료를 포함한 심리사회적 서비스가 암 의료에서 필수적인 요소가 되어가고, 정신적 스트레스의 선별과 조기 관리가 삶의 질과 생존율에도 관련된다는 설명을 개인 예후 개선으로 단정하지 않으면서 제 상태의 협진 목표, 상담·평가 일정, 주치의와 정신건강의학과 사이 정보 공유, 치료 계획에 반영할 확인 질문으로 어떻게 정리하면 좋을까요?",
    sourceId: "nccMentalHealthPsychiatryConsultBenefits",
  },
  {
    topic: "불안 신체증상·주의전환 상담 준비",
    question:
      "국가암정보센터 암생존자 마음관리의 내 안의 불안 다스리기 안내처럼 불안은 위험을 알려주는 몸의 경보장치로 설명되고, 심장이 빨리 뛰고 가슴이 두근거림, 땀, 몸이 떨리거나 떨림, 숨이 가쁘거나 답답함, 가슴 통증이나 불편감, 메스꺼움이나 위장 불편감, 어지럽거나 쓰러질 것 같은 느낌, 춥거나 화끈거리는 느낌으로 나타날 수 있다고 설명됩니다. 제 불안이 일상생활에 방해가 되는지, 현실적인 위험이 없는데도 오래 지속되는지, 피로, 잠들기 어렵거나 깊이 잠들지 못함, 집중하지 못하거나 결정을 내리지 못함, 짜증·안절부절못함과 함께 나타나는지를 어떻게 기록하면 좋을까요? 가족이나 가까운 사람, 암생존자 동료, 전문가에게 솔직하게 털어놓기, 음악·그림·책·영화·퍼즐·종이접기 같은 주의 전환, 얼음이나 고무공 같은 감각 집중, 복식호흡, 심상유도 같은 후보를 제 상태에서 어떤 순서로 진료팀과 확인하면 좋을까요?",
  ...
  {
    topic: "치료 후 고용량 영양식품·우유 질문 준비",
    question:
      "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상 자막처럼 암치료를 받은 암 환자분들은 너무 고용량의 또 뭔가 좋다는 영양 식품을 안 드시는 것이 가장 안전한 것이 현대 의학의 근거라고 설명됩니다. 특정한 음식을 뭔가 좋다고 너무 고용량으로 그것만 꾸준히 드시는 게 오히려 좋지 않고 골고루 잘 드시되, 불필요한 영양제 민간요법은 하지 말아야 한다는 설명을 제 보충제·농축식품·민간요법 목록, 복용량, 시작 시점, 기대 효과 문구와 함께 진료팀에 어떤 순서로 확인하면 좋을까요? 기름기가 적은 고단백 식품을 골고루 섭취하고 탄수화물도 좀 드셔야 되며, 우유 드셔도 되나요라는 질문에는 드셔도 됩니다라고 설명하고, 너무 달고 기름진 음식, 탄 음식, 가공육 가공식품 등은 줄이는 것이 좋겠다고 안내한 부분을 식단 처방이나 특정 음식 지시로 쓰지 않으면서 제 식사량, 단백질 후보, 탄수화물 섭취, 우유·유제품 소화 여부, 달고 기름진 음식·탄 음식·가공육·가공식품 노출을 어떻게 기록하면 좋을까요?",
    sourceId: "nccSurvivorHealthyManagementNutrition",
  },
  {
    topic: "치료 후 이차암 검진 구분 준비",
    question:
      "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상 자막처럼 이차암은 원발암, 즉 내가 처음 겪었던 암 외에 새로운 부위에 생기는 암이라고 설명되고, 이차암은 암 생존자에게 다른 암을 겪지 않은 사람보다 생길 확률이 높아지지만 아주 높지는 않으며 세계 여러 연구에서 한 10% 에서 20%정도 더 높아진다고 설명됩니다. 대장암, 유방암, 자궁경부암을 겪은 분들의 이차암 예시와 자궁경부암을 겪은 분들이 흡연을 한다면 폐암 검진을 확인해야 한다는 설명을 제 흡연 기간·양, 폐암 국가검진 대상 여부, 저선량 흉부 CT 안내, 다른 암종 국가 검진 통보 이력과 함께 진료팀과 검진기관에 어떤 순서로 확인하면 좋을까요? 치료받은 병원에서 원발암 재발 검사를 이어가고, 다른 부위 이차암은 국가 검진으로 구분해 챙기는 설명을 제 자궁경부암 추적검사 일정, 산정특례기간 국가검진 유예 여부, 다른 부위 증상이나 가족력, 검진 결과 공유 방식으로 어떻게 기록하면 좋을까요?",
    sourceId: "nccSurvivorHealthyManagementNutrition",
  },
  {
    topic: "암생존자 예방접종·생백신 시점 확인 준비",
    question:
      "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상 자막처럼 폐렴, 인플루엔자, 코로나 등의 감염병에 의한 사망과 중증화가 생길 수 있고, 대부분의 예방접종 백신은 사백신이지만 일부 예방접종은 생백신이라고 설명됩니다. 생백신은 항암치료 중 면역 저하 상태에서 감염병을 일으킬 수 있어 항암치료 한 달 전이나 항암치료 마치고 3개월 후라는 시점 설명과, 대표적인 대상포진 백신은 전신 항암치료 중 보류하고 치료 후 상태가 괜찮을 때 병원 상담으로 확인한다는 설명을 제 항암·방사선치료 일정, 면역저하 상태, 접종 이력, 알레르기·이상반응 이력과 함께 진료팀에 어떻게 확인하면 좋을까요? 침습성 폐렴구균 감염률이 암 치료를 받은 환자에서 10배 이상 증가할 수 있다는 설명, 13가와 23가 폐렴구균 백신의 접종 이력·간격·5년 후 재접종 확인, 독감 예방접종을 매년 확인해야 한다는 설명, 코로나19·파상풍·HPV 접종 후보를 제 나이, 치료 종류, 65세 이상 무료 23가 접종 여부, 지역 보건소·병의원 안내와 함께 어떤 순서로 정리하면 좋을까요?",
    sourceId: "nccSurvivorHealthyManagementNutrition",
  },
  {
...
export const cervicalCancerCareChecks: CervicalCancerCareCheck[] = [
  {
    label: "출혈·분비물 기록",
    detail:
      "날짜, 양, 색, 냄새, 성관계/운동/배변 후 발생 여부를 한 줄로 남깁니다.",
    sourceId: "nccSymptoms",
  },
  {
    label: "통증·부종 추세",
    detail:
      "골반통·요통·하지 통증·다리 부종은 0-10점, 좌우 차이, 악화 요인을 함께 적습니다.",
  ...
  },
  {
    label: "생활 제한 확인",
    detail:
      "수술 후 무거운 물건, 부부관계, 운전, 운동 재개는 치료 범위별로 진료팀 지시를 우선합니다.",
    sourceId: "nccRecovery",
  },
  {
    label: "추적검사 일정·결과",
...
export const cervicalCancerCareRecoveryGuides: CervicalCancerCareRecoveryGuide[] =
  [
    ...
    },
    {
      ...
      detail:
        "국가암정보센터는 디스트레스를 암생존자의 몸과 마음에 나타나는 모든 괴로움으로 설명하고, 모든 암환자의 20~40%, 즉 10명 중 2명에서 4명이 디스트레스를 겪는다고 안내합니다. 다스리기 어려운 고통스러운 신체 증상, 외모에 원하지 않은 변화, 원래 있던 마음 문제 악화, 역할이나 관계 변화, 돌보아야 하는 아이, 부모님께 다시 도움을 받는 상황, 주변 사람들에게 암 이야기를 해야 하는 부담, 새로운 직장이나 복귀 후 기대와 실제 상태 차이, 암 관리에 대한 정보가 부족하거나 암 관리를 계속해야 한다는 부담을 기록합니다. 걱정, 두려움, 불안, 숨쉬기 답답함, 우울함, 절망감, 의욕 저하, 짜증, 잠들기 어렵거나 잠에서 쉽게 깹니다, 사람들과 사이가 안 좋아지거나 혼자라는 느낌, 살고 싶지 않거나 죽고 싶다는 생각, 식사량의 큰 변화, 가치 없다는 느낌, 죽음에 관한 두려움은 진료팀과 보호자에게 공유할 신호로 남깁니다. 자녀보육, 경제적 문제, 직장/학교, 우울/슬픔, 재발/죽음에 대한 불안, 식사, 피로, 기억력/집중력, 통증 등 자가평가에서 예가 많을수록 관심과 도움이 필요하다는 신호로 기록하되, 진단이나 치료 지시가 아니라 도움 요청과 상담 준비 문구로 사용합니다.",
      sourceId: "nccSurvivorDistressAdaptation",
    },
    {
      label: "스트레스 원인 오해·관리 메모",
      detail:
        "국가암정보센터 암환자 정신건강 인터뷰는 스트레스를 많이 받아서 암에 걸린 걸까요라는 질문에서 암환자들은 흔히 누군가를 탓하고 싶은 마음이 들고, 암이 스트레스 때문에 생겼다고 생각하는 경우에는 스트레스를 불러일으킨 상황이나 사람을 탓하는 경향이 있다고 설명합니다. 그러나 스트레스가 직접적인 발암인자, 암이 생기게 한 원인이라고 할 수는 없습니다라고 설명하므로, 이 항목은 원망·죄책감·가족이나 직장 갈등을 기록하되 암 원인 단정이나 책임 전가로 쓰지 않습니다. 스트레스가 암의 원인은 아닐지 몰라도 이미 암이 있는 환자에게는 면역력을 약화시켜 악성세포의 성장에 영향을 준다는 설명은 개인 면역 회복이나 종양 변화 보장으로 해석하지 않고, 스트레스 양상과 수면·식사·통증·관계 부담을 진료팀 확인 질문으로 남깁니다. 스트레스를 피하는 것보다 건전한 스트레스 해소법으로 잘 관리하는 것이 중요하고 적당한 운동, 건강한 식생활, 좋은 대인관계, 건전한 신앙생활 등이 예로 제시되므로, 내 치료 일정과 몸 상태에서 가능한 활동·식사·관계·믿음 또는 가치관 지원을 확인할 질문으로 정리합니다.",
      sourceId: "nccMentalHealthStressCancerCause",
    },
    {
      label: "암치료 후 슬럼프·우울상담 메모",
      detail:
        "국가암정보센터 암환자 정신건강 안내는 암 진단 후에 수술과 항암화학요법, 방사선치료까지 마쳤다는 것은 초기 치료가 일단락되었음을 의미한다고 설명합니다. 우울증은 암 진단 직후나 치료 중에 많이 생기지만 처음에는 멀쩡하다가 한참 후에 우울증이 나타나는 경우도 흔하다고 하므로, 치료 종료 후 눈물이 남, 울적함, 의욕 저하, 좌절감, 절망감, 고립감, 고독감, 허무감의 시작 시점과 지속 기간을 기록합니다. 일차적인 치료가 종결된 뒤 혼자서 관리해야 한다는 부담감과 재발이나 전이에 대한 막연한 두려움을 진료팀과 보호자에게 공유할 문구로 남깁니다. 우울한 기분이나 의욕 상실이 한 달 이상 가거나 정도가 심한 경우 정신건강의학과 상담과 항우울제 처방 필요 여부를 전문가의 도움 기준으로 확인하되, 이 메모는 진료를 대신하거나 항우울제 처방을 지시하지 않습니다.",
      sourceId: "nccSurvivorPostTreatmentSlump",
    },
    {
      label: "불면증·정신과 약 중독 우려 메모",
      detail:
        "국가암정보센터 암환자 정신건강 인터뷰는 암 진단 후 잠을 잘 못 잘 때 정신건강의학과 약을 먹으면 중독되는지 묻는 상황을 다루며, 정신건강의학과에 대한 편견으로 약을 한 번 먹으면 끊지 못한다는 통념, 진료기록과 취직·보험 걱정이 있다고 설명합니다. 도움이 필요한데도 편견 탓에 적절한 서비스를 받지 못하는 환자가 많다는 설명을 기준으로 불면 기간, 밤에 깨는 양상, 우울·불안 동반, 진료기록·보험·직장 걱정, 약을 끊지 못할까 하는 우려를 기록합니다. 가벼운 불면·우울·불안은 약 없이 상담만으로도 도움을 받을 수 있고, 수면제·항우울제·항불안제 등 정신약물요법이 필요한 경우에도 증상 조절 목적이며 대부분 단기간에 끊을 수 있다는 설명은 내 상태의 상담 가능성, 약물 필요 여부, 예상 기간, 부작용, 중단 계획, 주치의와 정신건강의학과 협진 질문으로 확인합니다. 이 메모는 수면제나 정신과 약 복용을 지시하거나 중독 가능성을 단정하지 않습니다.",
      sourceId: "nccMentalHealthInsomniaMedicationConcern",
    },
    {
      label: "정신건강의학과 진료 도움 확인 메모",
      detail:
        "국가암정보센터 암환자 정신건강 인터뷰는 주치의가 정신건강의학과 진료를 권했을 때, 암환자의 절반 가까이가 투병 중에 정신건강의학적 문제를 겪을 수 있고 불면이나 우울, 불안 등의 증상이 심하거나 오래 지속되면 정신적 고통 때문에 정신신경 면역학적 기전을 통해 면역력이 떨어질 수 있다고 설명합니다. 불면·우울·불안의 시작 시점, 지속 기간, 심한 정도, 치료 일정과의 관계, 식사·수면·일상생활·치료 이해도 영향을 기록합니다. 정신건강의학과 진료를 포함한 심리사회적 서비스가 암 의료에서 필수적인 요소가 되어가고, 정신적 스트레스 선별과 조기 관리가 삶의 질과 생존율에도 관련된다는 설명은 내 상태의 협진 목표, 상담·평가 일정, 주치의와 정신건강의학과 사이 정보 공유 질문으로 확인하되, 개인 예후 개선으로 단정하지 않습니다.",
      sourceId: "nccMentalHealthPsychiatryConsultBenefits",
    },
    {
      label: "암생존자 불안신호·주의전환 메모",
      detail:
        "국가암정보센터는 불안을 위험을 알려주는 몸의 경보장치로 설명하며, 심장이 빨리 뛰고 가슴이 두근거림, 땀, 몸이 떨리거나 떨림, 숨이 가쁘거나 답답함, 가슴 통증이나 불편감, 메스꺼움이나 위장 불편감, 어지럽거나 쓰러질 것 같은 느낌, 춥거나 화끈거리는 느낌 같은 신체 신호를 안내합니다. 일상생활에 방해가 되거나 현실적 위험 없이 오래 지속되는 불안, 피로, 잠들기 어렵거나 깊이 잠들지 못함, 집중하지 못하거나 결정을 내리지 못함, 짜증·안절부절못함이 함께 있는지 기록합니다. 가족이나 가까운 사람, 암생존자 동료, 전문가에게 솔직하게 털어놓기, 음악·그림·책·영화·퍼즐·종이접기 같은 주의 전환, 얼음이나 고무공 같은 감각 집중, 복식호흡, 심상유도는 임의 치료 지시가 아니라 내 상태에서 가능한지 진료팀과 보호자에게 확인할 후보로 남깁니다.",
      sourceId: "nccSurvivorAnxietyManagement",
    },
    {
      label: "불면·수면효율·습관 메모",
    ...
    },
    {
      ...
      detail:
        "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상은 암치료를 받은 암 환자분들은 너무 고용량의 또 뭔가 좋다는 영양 식품을 안 드시는 것이 가장 안전한 것이 현대 의학의 근거라고 설명합니다. 특정한 음식을 뭔가 좋다고 너무 고용량으로 그것만 꾸준히 드시는 게 오히려 좋지 않고, 불필요한 영양제 민간요법은 하지 말아야 한다는 설명은 보충제·농축식품·민간요법의 이름, 용량, 시작 시점, 기대 효과 문구를 진료팀 확인 메모로 남기는 데 사용합니다. 같은 영상은 기름기가 적은 고단백 식품을 골고루 섭취하고 탄수화물도 좀 드셔야 된다고 설명하고, 우유 드셔도 되나요라는 질문에는 드셔도 됩니다라고 답하며, 너무 달고 기름진 음식, 탄 음식, 가공육 가공식품 등은 줄이는 것이 좋겠다고 안내합니다. 이 항목은 우유나 고단백 식품을 먹으라는 지시가 아니라, 식사량, 단백질 후보, 탄수화물 섭취, 우유·유제품 소화 여부, 달고 기름진 음식·탄 음식·가공육·가공식품 노출을 제 치료 후 상태와 동반질환 기준으로 진료팀 확인하는 메모입니다.",
      sourceId: "nccSurvivorHealthyManagementNutrition",
    },
    {
      label: "암생존자 이차암 검진·흡연력 메모",
      detail:
        "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상은 이차암은 원발암, 즉 내가 처음 겪었던 암 외에 새로운 부위에 생기는 암이라고 설명합니다. 이차암은 암 생존자에게 다른 암을 겪지 않은 사람보다 생길 확률이 높아지지만 아주 높지는 않으며, 세계 여러 연구에서 한 10% 에서 20%정도 더 높아진다고 설명합니다. 대장암, 유방암, 자궁경부암을 겪은 분들의 이차암 예시와 자궁경부암을 겪은 분들이 흡연을 한다면 폐암 검진을 확인해야 한다는 설명은 흡연 기간·양, 폐암 국가검진 대상 여부, 저선량 흉부 CT 안내, 다른 암종 국가 검진 통보 이력을 기록하는 데 사용합니다. 이 항목은 검진 명령이 아니라, 치료받은 병원에서 원발암 재발 검사를 이어가고 다른 부위의 이차암은 국가 검진으로 구분해 챙기는 설명을 제 추적검사 일정, 산정특례기간 국가검진 유예 여부, 다른 부위 증상이나 가족력, 결과 공유 방식과 함께 진료팀 확인 메모로 남깁니다.",
      sourceId: "nccSurvivorHealthyManagementNutrition",
    },
    {
      label: "암생존자 예방접종·생백신 시점 메모",
      detail:
        "국가암정보센터 암생존자 예방접종 및 슬기로운 건강관리 영상은 폐렴, 인플루엔자, 코로나 등의 감염병에 의한 사망과 중증화가 생길 수 있고, 대부분의 예방접종 백신은 사백신이지만 일부 예방접종은 생백신이라고 설명합니다. 생백신은 항암치료 중 면역 저하 상태에서 감염병을 일으킬 수 있어 항암치료 한 달 전이나 항암치료 마치고 3개월 후라는 시점 설명과, 대표적인 대상포진 백신은 전신 항암치료 중 보류하고 치료 후 상태가 괜찮을 때 병원 상담으로 확인한다는 설명을 접종 이력·치료 일정 메모로 남깁니다. 같은 영상은 침습성 폐렴구균 감염률이 암 치료를 받은 환자에서 10배 이상 증가할 수 있다고 설명하고, 13가와 23가 폐렴구균 백신의 접종 이력·간격·5년 후 재접종 확인, 독감 예방접종을 매년 확인해야 한다는 설명, 코로나19·파상풍·HPV 접종 후보를 다룹니다. 이 항목은 예방접종 명령이 아니라 항암·방사선치료 일정, 면역저하 상태, 알레르기·이상반응 이력, 65세 이상 무료 23가 접종 여부, 지역 보건소·병의원 안내를 진료팀 확인 메모로 남기는 용도입니다.",
      sourceId: "nccSurvivorHealthyManagementNutrition",
    },
    {
...
export function buildCervicalCancerScreeningSummary(
  ...
  if (age === null) {
    return {
      action:
        "나이를 입력한 뒤 국가암검진 대상 여부와 병원 추적검사 일정을 함께 확인합니다.",
      detail:
        "국가암검진 기준은 20세 이상 여성, 2년 간격 자궁경부세포검사입니다.",
  ...
  if (profile.sex === "female" && age >= 20) {
    return {
      ...
      detail:
        "20세 이상 여성은 국가암검진 기준상 2년 간격 자궁경부세포검사 대상입니다.",
      sourceIds: baseSourceIds,
  ...
  if (profile.sex === "female") {
    return {
      action:
        "증상, 치료 이력, 가족 상담 필요가 있으면 국가암검진 연령 전이라도 진료팀 기준을 따릅니다.",
  ...
  return {
    action:
      "자궁경부 보유 여부, 치료 이력, 검진 필요성은 개인 상황에 맞게 진료팀에 확인합니다.",
    detail:
      "국가암검진 표의 자궁경부암 대상은 20세 이상 여성 기준으로 표시됩니다.",
    sourceIds: ["nccScreeningEligibility"],
...
export function formatCervicalCancerScreeningQuestionDraftReadyStatus(
  ...
  const sourceLabels = summary.sourceIds
    .map(
      (sourceId) =>
        getCervicalCancerCareSource(sourceId)?.label ??
        "공식 자궁경부암 케어 자료",
    )
    .join(", ");
...
export function formatCervicalCancerCareAlertDraftActionLabel(
  alert: CervicalCancerCareAlert,
) {
  return `${alert.title} 자궁경부암 증상 기록 초안 만들기`;
}

export function formatCervicalCancerCarePromptDraftActionLabel(
...
export function buildCervicalCancerCarePromptQuestion(
  prompt: CervicalCancerCarePrompt,
) {
...
export function formatCervicalCancerCareAlertEvidence(
  alert: CervicalCancerCareAlert,
) {
