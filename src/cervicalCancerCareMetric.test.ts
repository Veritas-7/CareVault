...
describe("cervicalCancerCareMetric", () => {
  it("builds panel summary chips for the profile-specific cervical-care note", () => {
    expect(
      ...
      ariaLabel:
        "전체 48개 · 우선 3개 · 검진요약 1개 · 기록항목 4개 · 경고 4개 · 질문 10개 · 기록/회복/예방 26개 · 공식 출처 19개",
      items: [
        { id: "total", label: "전체", value: "48개" },
        ...
        { id: "record-recovery-prevention", label: "기록/회복/예방", value: "26개" },
        { id: "source", label: "공식 출처", value: "19개" },
      ],
    });
  });
  ...
  it("omits screening-summary chips when no profile-specific screening summary is copied", () => {
    expect(
      ...
      ariaLabel:
        "전체 47개 · 우선 3개 · 기록항목 4개 · 경고 4개 · 질문 10개 · 기록/회복/예방 26개 · 공식 출처 19개",
      items: [
        { id: "total", label: "전체", value: "47개" },
        { id: "priority", label: "우선", value: "3개" },
        { id: "alert-record-field", label: "기록항목", value: "4개" },
        { id: "alert", label: "경고", value: "4개" },
        { id: "prompt", label: "질문", value: "10개" },
