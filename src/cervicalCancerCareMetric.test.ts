...
describe("cervicalCancerCareMetric", () => {
  it("builds panel summary chips for the profile-specific cervical-care note", () => {
    expect(
      ...
      ariaLabel:
        "전체 125개 · 우선 3개 · 검진요약 1개 · 기록항목 4개 · 경고 4개 · 질문 45개 · 기록/회복/예방 68개 · 공식 출처 53개",
      items: [
        { id: "total", label: "전체", value: "125개" },
        ...
        { id: "prompt", label: "질문", value: "45개" },
        { id: "record-recovery-prevention", label: "기록/회복/예방", value: "68개" },
        { id: "source", label: "공식 출처", value: "53개" },
      ],
    });
  });
  ...
  it("omits screening-summary chips when no profile-specific screening summary is copied", () => {
    expect(
      ...
      ariaLabel:
        "전체 124개 · 우선 3개 · 기록항목 4개 · 경고 4개 · 질문 45개 · 기록/회복/예방 68개 · 공식 출처 53개",
      items: [
        { id: "total", label: "전체", value: "124개" },
        { id: "priority", label: "우선", value: "3개" },
        { id: "alert-record-field", label: "기록항목", value: "4개" },
        { id: "alert", label: "경고", value: "4개" },
        { id: "prompt", label: "질문", value: "45개" },
