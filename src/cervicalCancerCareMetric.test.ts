...
describe("cervicalCancerCareMetric", () => {
  it("builds panel summary chips for the profile-specific cervical-care note", () => {
    expect(
      ...
      ariaLabel:
        "전체 54개 · 우선 3개 · 검진요약 1개 · 기록항목 4개 · 경고 4개 · 질문 10개 · 기록/회복/예방 32개 · 공식 출처 21개",
      items: [
        { id: "total", label: "전체", value: "54개" },
        ...
        { id: "record-recovery-prevention", label: "기록/회복/예방", value: "32개" },
  ...
  it("omits screening-summary chips when no profile-specific screening summary is copied", () => {
    expect(
      ...
      ariaLabel:
        "전체 53개 · 우선 3개 · 기록항목 4개 · 경고 4개 · 질문 10개 · 기록/회복/예방 32개 · 공식 출처 21개",
      items: [
