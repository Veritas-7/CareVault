  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "장출혈성 대장균, 장관출혈성대장균, 대장균 O157:H7, 출혈성 대장염, 용혈성요독증후군, 혈전성혈소판 감소증, 햄, 치즈, 소시지, 채소샐러드, 분유, 두부, 음료수, 어패류, 도시락, 급식, 환자나 보균자의 분변, 소, 돼지와 개, 고양이 등의 분변, 보균자가 화장실을 비위생적으로 사용할 때, 하천수와 어패류 등에서 분리 검출, 1차 및 2차 오염으로 감염될 수 있다, 조리기구(칼, 도마 등) 구분 사용으로 2차 오염을 방지하여야 한다, 생육과 조리된 음식을 구분하여 보관하여야 한다, 다진 고기는 중심부 온도가 75℃ 1분 이상 가열하여야 한다",
