...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "부드럽고 촉촉한 음식을 준비합니다. 씹고 삼키기 쉬운 음식을 먹습니다. 죽류 : 흰죽, 닭죽, 고기죽, 전복죽, 호박죽, 야채죽, 계란죽 등. 미음 : 쌀미음, 조미음, 잣미음, 깨미음, 녹두미음 등. 요리를 할 때는 부드럽고 연해질 때까지 하도록 하며, 음식을 작은 크기로 자릅니다. 경우에 따라서는 믹서로 곱게 갈도록 합니다. 얼음조각을 먹는 것도 도움이 됩니다. 흰죽, 닭죽, 고기죽, 전복죽, 호박죽, 야채죽, 계란죽, 쌀미음, 조미음, 잣미음, 깨미음, 녹두미음, 부드러운 야채, 데친 채소, 바나나, 배, 수박, 과일통조림",
