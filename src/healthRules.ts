...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "익힌 단백질·수분",
        detail:
          "치료 중 영양 자료는 탄수화물, 단백질, 비타민·무기질, 물을 기본 영양소로 설명하고, 감자·고구마·옥수수 같은 탄수화물 식품과 성인 하루 물 6~8컵을 예시로 안내합니다. 건강한 식생활 자료는 육류 섭취 시 구워 먹기보다는 삶거나 끓인 조리 예시를 제시하며, 면역저하가 있으면 안전하게 익힌 음식인지 함께 확인합니다.",
        examples:
