  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 어떤 특정 식품이나 음식에 의해 암의 재발을 막는다는 연구보고는 없다고 설명합니다. 치료 후 부작용 등으로 적절한 식사 섭취가 힘들거나 고혈압·당뇨병·고지혈증 등으로 식사조절이 필요하면 담당의사 및 임상영양사와 상담하고, 건강보조식품이나 민간요법은 안전성과 효과가 과학적으로 입증되지 않은 경우가 많아 주의하도록 안내합니다.",
        examples:
          "어떤 특정 식품이나 음식에 의해 암의 재발을 막는다는 연구보고는 없습니다., 치료 후 부작용으로 식사 섭취 힘듦, 치료 후 건강보조식품 민간요법 주의",
        sourceIds: ["nccAfterTreatmentHealthyEating"],
      },
      {
