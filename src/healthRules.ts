...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "채소·과일·통곡물·콩류",
        detail:
          "국가암정보센터 건강한 식생활 자료는 채소류(생채소, 나물, 샐러드, 쌈류 등)를 매일, 매끼니 충분히 먹고, 과일류는 매일 1회 이상 간식으로 섭취하며, 다양한 종류의 잡곡과 도정하지 않은 곡류를 섭취하고, 두류와 두유·두부 같은 두류 가공품을 매일 섭취하며, 하루 1잔 정도의 저지방 우유를 권하고 김치류는 짜지 않게 만들어 먹도록 안내합니다.",
        examples:
