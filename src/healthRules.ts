    ...
    items: [
      {
        ...
        examples:
          "자궁경부암 환자가 특별히 피해야 하거나 환자에게 추천하는 음식은 없습니다., 충분한 영양을 섭취하고 휴식을 취하는 것이 몸의 면역 기능 강화와 투병 생활에 도움이 될 수 있습니다., 평소 먹기 쉬운 음식, 소량씩 자주 먹기, 통증·식욕 저하를 진료팀에 공유",
      ...
      },
      {
        label: "실천지침 식단 예시",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침은 채소·과일을 충분히 섭취하고 짠 음식과 탄 음식을 제한하는 식단 예시를 제시합니다. 식단 작성 시 파프리카·피망·시금치·토마토·당근·양배추처럼 식품이 지닌 색상을 고려해 다양한 색상이 포함되도록 식품을 선택하라고 안내합니다. 예시 식단은 채소샐러드에 요플레드레싱을 사용해 채소 섭취량을 늘리고, 북어콩나물국과 쇠고기뭇국의 소금·간장 사용을 줄이며, 우엉조림을 우엉볶음으로 바꾸어 나트륨 섭취를 줄이는 조리 예시도 함께 보여줍니다.",
        examples:
          "파프리카, 피망, 시금치, 토마토, 당근, 양배추 등 식품이 지닌 색상을 고려하여 다양한 종류의 색상이 포함되도록 식품을 선택해 보십시오., 파프리카, 피망, 토마토, 잡곡밥, 과일샐러드, 채소샐러드, 채소 섭취량 증가(채소샐러드는 요플레드레싱 사용), 브로콜리회, 귤, 딸기 요플레, 북어콩나물국, 소금 및 간장 사용량 감소(소금 섭취량 감소), 시금치나물, 우엉볶음, 우엉조림 → 우엉볶음 : 간장 사용량 감소(소금 섭취량 감소), 쇠고기뭇국, 소금 대신 간장 사용으로 나트륨 섭취량 감소",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "실천지침 대체 식단 예시",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침의 예시 식단은 식이섬유를 늘리는 잡곡밥 대체 예시와 함께 가공육·달콤한 간식·짠 반찬·국물 과다와 나트륨이 많은 조림을 줄이고 과일·채소·저염 조리 예시로 바꾸는 방향을 보여주며, 국 또는 찌개의 국물은 다 먹지 않도록 안내합니다. 식생활 습관 개선 시 지방 함량이 높은 식품이나 짠 음식 섭취를 줄이고 신선한 채소·과일·곡류를 자주 먹으며, 가능한 제철 과일·채소를 구입하고 곰팡이 핀 음식은 피하라고 안내합니다.",
        examples:
          "쌀밥, 흰쌀밥, 햄구이, 초코칩쿠키, 단무지, 우엉조림, 국·찌개 국물, 국물 과다, 국 또는 찌개의 국물은 다 드시지 마십시오., 가능한 지방 함량이 높은 식품이나 짠 음식 섭취를 줄이겠다는 생각을 가지며, 신선한 채소와 과일, 곡류 등을 자주 드시기 바랍니다., 가능한 제철 과일, 채소를 구입하십시오. 곰팡이 핀 음식은 피하시기 바랍니다.",
        sourceIds: ["nccCervicalPracticeDiet"],
      },
      {
      ...
      },
      {
        label: "금연 보조 식이요법",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침은 금연을 돕는 식이요법으로 맵고 짠 자극적인 음식이나 지방이 많은 느끼한 음식과 육식을 가급적 피하고, 과식은 피하면서 금연을 위한 간식을 준비하도록 안내합니다. 식품 자체를 자궁경부암 치료식으로 보지 않고 금연 실천 보조 기록 후보로 다룹니다.",
        examples:
          "맵고 짠 자극적인 음식이나 지방이 많은 느끼한 음식, 육식은 가급적 피하기, 과식은 피하고 평소 섭취하는 열량의 80% 정도만 섭취하고, 금연을 위한 간식으로 당근, 오이, 다시마, 무가당 껌, 은단 등을 준비하기",
        sourceIds: ["nccCervicalPracticeDiet"],
      },
      {
        label: "입안 자극 음식",
    ...
    items: [
      {
        ...
        examples:
          "또한 항암화학요법을 받는 중에는 민간요법이나 건강보조식품은 삼갑니다., 민간요법이나 건강보조식품은 과학적으로 효능이 확인되지 않았으며 병원에서 투여하는 약제와 예상할 수 없는 상호작용으로 치료효과가 떨어지거나 부작용이 커질 수도 있기 때문입니다., 고농축 보충제, 영양제, 약초, 한약, 민간요법, 치료 효과를 표방하는 식품",
