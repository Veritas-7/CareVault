...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 중 건강식을 먹는 요령 자료는 식사가 치료의 보조 요법만큼 중요하다고 설명하며, 규칙적인 아침·점심·저녁 식사, 밥 반 그릇에서 한 그릇 또는 죽 하루 4~5번 이상, 끼니마다 충분한 단백질 반찬, 매끼 두 가지 이상 채소 반찬, 씹거나 삼키기 힘든 경우 다지거나 갈아서 먹기, 과일 하루 한두 번, 우유와 유제품 하루 1컵 이상과 요구르트·두유·치즈 대체, 식용유·참기름·버터 등 기름을 볶음이나 나물 요리 양념으로 쓰는 방법을 안내합니다.",
        examples:
          "규칙적으로 아침, 점심, 저녁 식사를 하며, 반찬을 골고루 먹습니다., 밥은 매끼 반 그릇에서 한 그릇 정도 먹고, 간식으로 빵 종류와 크래커, 떡 등을 조금씩 먹습니다. 죽을 먹어야 하는 경우에는 하루 4~5번 이상 자주 드는 것이 좋습니다., 끼니마다 고기나 생선, 달걀, 두부, 콩, 치즈 등 단백질 반찬을 충분히 곁들입니다., 채소 반찬은 매끼 두 가지 이상을 충분히 먹습니다., 씹거나 삼키기 힘든 경우에는 다지거나 갈아서 먹습니다., 한 가지 이상의 과일을 하루에 한두 번 정도 먹는 것이 좋습니다., 우유와 유제품은 하루 1컵(200ml) 이상 마십니다., 우유가 맞지 않을 경우엔 요구르트, 두유, 치즈 따위를 대신 먹습니다., 식용유, 참기름, 버터 등의 기름은 볶음이나 나물 요리에 양념으로 사용합니다., 치료 중 규칙적인 아침 점심 저녁, 치료 중 밥 반 그릇에서 한 그릇, 치료 중 죽 하루 4~5번 이상, 치료 중 단백질 반찬 충분히, 치료 중 채소 반찬 매끼 두 가지 이상, 치료 중 과일 하루 한두 번, 치료 중 우유와 유제품 하루 1컵, 치료 중 요구르트 두유 치즈",
