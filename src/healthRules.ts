...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 구토 자료는 구토 증상이 있을 때는 먹거나 마시지 않고, 구토증상이 조절되면 물이나 육수 등과 같은 맑은 유동식부터 조금씩 먹어보고 차츰 양을 증가시키며, 맑은 유동식으로 적응되면 미음·부드러운 식사로 바꾸고, 우유 소화가 힘들면 우유가 들어있지 않은 제품을 이용하도록 안내합니다.",
        examples:
          "구토증상이 조절되면, 물이나 육수 등과 같은 맑은 유동식부터 조금씩 먹어보고 차츰 양을 증가시키도록 합니다., 구토 조절 후 물, 구토 조절 후 육수, 구토 맑은 유동식, 구토 후 미음, 구토 후 부드러운 식사, 우유가 들어있지 않은 제품",
