  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 자궁경부암 예방과 음식 자료는 카로테노이드와 비타민 A·C·E 등이 예방 가능성이 있는 음식으로 거론되지만 아직 효과가 명확하지 않다고 설명합니다. 비타민 C도 일부 연구 결과와 위험도 감소 가능성 결론이 함께 소개되지만 이후 연구에서 예방 효과가 항상 명확히 보도된 것은 아니었다고 설명하므로, 식단 기록에서는 특정 영양소나 식품을 예방·치료 효과로 단정하지 않도록 확인합니다.",
        examples:
          "자궁경부암의 예방 가능성이 있는 음식으로 카로테노이드(carotenoid), 비타민 A, 비타민 C, 비타민 E 등이 거론되나 아직 그 효과에 대해서는 명확하지 않은 상태입니다., 비타민 C의 섭취가 많은 집단의 자궁경부암 발생 빈도가 20~50 %까지 감소한다는 연구 결과가 나온 바 있습니다. 그러나 이후 연구에서 항상 예방 효과가 명확히 보도된 것은 아니었기 때문에 현재 미국암연구협회(American Institute for Cancer Research)에서는 “비타민 C의 다량의 섭취가 자궁경부암의 위험도를 줄일 가능성이 있다”라고 결론을 내렸습니다.",
        sourceIds: ["nccCervicalFoodPrevention"],
      },
      {
