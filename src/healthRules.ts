...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 입안의 건조증 자료는 가까운 장소에 물을 두어 조금씩 자주 마시고, 음식을 먹을 때 육수나 국물 등에 담그거나 적셔서 먹으며, 삼키기 쉽게 하기 위해 음식에 소스나 드레싱을 첨가하여 촉촉하게 하고, 식사 중간에 자주 물이나 음료를 한 모금씩 마시며 빨대를 이용하면 삼키는 것에 도움이 될 수 있고, 딱딱한 사탕을 빨거나 껌을 씹는 것도 침 분비를 도와줄 수 있다고 안내합니다.",
        examples:
          "가까운 장소에 물을 두어 조금씩 자주 마시도록 합니다. 음식을 먹을 때 육수나 국물 등에 담그거나 적셔서 먹도록 합니다. 삼키기 쉽게 하기 위해 음식에 소스나 드레싱을 첨가하여 촉촉하게 합니다. 식사 중간에 자주 물이나 음료를 한 모금씩 마시도록 합니다. 빨대를 이용하면 삼키는 것에 도움이 됩니다. 딱딱한 사탕을 빨거나 껌을 씹는 것도 침 분비를 도와줄 수 있습니다. 물 조금씩 자주, 물 한 모금, 소스나 드레싱, 딱딱한 사탕, 껌, 껌 씹기",
