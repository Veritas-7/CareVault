...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "변비 시 수분·섬유소",
        detail:
          "국가암정보센터 변비 자료는 하루 8~10컵 이상 수분을 충분히 섭취하고, 음식 섭취량이 너무 적지 않도록 하며, 특히 아침 기상 직후 찬물을 마시는 것이 장운동에 도움이 될 수 있고, 도정이 덜 된 곡류, 생과일, 생야채 등 섬유소가 많은 식품을 충분히 섭취하며, 자신에게 맞는 가벼운 산책이나 걷기 등 규칙적인 운동이 도움이 될 수 있다고 안내합니다.",
        examples:
          "수분을 충분히 섭취합니다.(하루에 8~10컵 이상) 이는 변을 부드럽게 합니다., 음식 섭취량이 너무 적지 않도록 합니다., 특히 아침 기상 직후에 차가운 물을 마시면 장운동에 도움이 됩니다., 도정이 덜 된 곡류, 생과일, 생야채 등 섬유소가 많은 식품을 충분히 섭취합니다., 가벼운 산책이나 걷기 등의 자신에게 맞는 운동을 규칙적으로 하는 것이 도움이 됩니다., 변비 물 8~10컵, 변비 하루 8~10컵 물, 변비 아침 찬물, 변비 도정 덜 된 곡류, 변비 생과일, 변비 생야채, 변비 섬유소 많은 식품",
