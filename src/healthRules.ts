  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "생굴, 회, 초밥, 육회, 생조개, 날계란, 덜 익힌 고기, 날계란이나 덜 익힌 계란이 들어간 음식, 다진 고기, 가는 과정에서 오염 가능, 씻지 않은 딸기, 딸기 등 꼼꼼히 씻기 어려운 과일, 오래된 남은 음식, 3~4일 지난 남은 음식, 곰팡이가 핀 음식, 곰팡이 핀 음식, 상온 30분 이상 운반, 녹슨 캔, 움푹해진 캔, 냉동제품 녹음, 비살균 우유·주스, 비살균 쥬스, 비살균 요구르트",
        sourceIds: ["nccImmuneLowDiet"],
      },
    ],
  },
