  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "가공육·탄 음식·튀김",
        detail:
          "국가암정보센터 암예방 식단 예시는 햄·소시지 등 가공육류를 가급적 적게 섭취하고 직화 구이와 튀김 조리법을 피하도록 안내하며, 건강한 식생활 자료도 햄·소시지 등 육가공품을 가급적 먹지 않기, 탄 음식은 먹지 않기, 숯불로 굽거나 직접 구워 탄 음식의 섭취는 삼가하기, 지방 함량이 많은 부위의 육류 섭취 제한을 안내합니다.",
        examples:
