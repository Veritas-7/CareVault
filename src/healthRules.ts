...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 입과 목의 통증 자료는 부드럽고 촉촉한 음식을 준비하고, 씹고 삼키기 쉬운 음식을 먹도록 하며, 죽류, 미음, 부드럽게 조리한 고기·생선, 익히거나 데친 채소, 바나나·배·수박·과일통조림처럼 시지 않은 과일을 예시로 안내합니다.",
        examples:
          "부드럽고 촉촉한 음식을 준비합니다. 씹고 삼키기 쉬운 음식을 먹습니다. 흰죽, 닭죽, 고기죽, 전복죽, 호박죽, 야채죽, 계란죽, 쌀미음, 조미음, 잣미음, 깨미음, 녹두미음, 부드러운 야채, 데친 채소, 바나나, 배, 수박, 과일통조림",
