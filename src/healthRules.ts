...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "자궁경부암 예방과 음식 자료는 베타카로틴이 풍부한 신선식품 예시를 제시하지만 카로테노이드·비타민 식품의 예방 효과가 아직 명확하지 않다고 설명하고, 조기 검진과 정기 검진이 가장 효과적인 예방 방법이며 일반적인 건강 생활로 신선한 채소·과일 섭취가 좋다고 안내하므로 치료식으로 보지 않고 신선한 채소·과일·해조류 섭취 질문으로 남깁니다.",
        examples:
          "카로틴(carotene)과 거의 유사한 구조를 가진 물질을 카로테노이드라고 하며, 그 중 베타카로틴 은 당근, 시금치, 차, 미역 등 신선한 채소, 과일, 해조류에 풍부합니다., 그러므로 자궁경부암의 예방을 위해서는 조기 검진과 정기 검진이 가장 효과적인 방법이며, 일반적으로 건강한 생활을 위해서는 신선한 채소 및 과일을 충분히 섭취하는 것이 좋습니다., 당근, 시금치, 차, 미역, 신선한 채소, 과일, 해조류",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 자궁경부암 예방과 음식 자료는 카로테노이드와 비타민 A·C·E 등이 예방 가능성이 있는 음식으로 거론되지만 아직 효과가 명확하지 않다고 설명합니다. 비타민 C도 일부 연구 결과와 위험도 감소 가능성 결론이 함께 소개되지만 이후 연구에서 예방 효과가 항상 명확히 보도된 것은 아니었다고 설명하고, 비타민 E도 위험도가 낮은 경향과 예방 효과 가능성이 소개되지만 아직 확실히 결론을 내린 것은 아니었다고 설명하므로, 식단 기록에서는 특정 영양소나 식품을 예방·치료 효과로 단정하지 않도록 확인합니다.",
        examples:
          "자궁경부암의 예방 가능성이 있는 음식으로 카로테노이드(carotenoid), 비타민 A, 비타민 C, 비타민 E 등이 거론되나 아직 그 효과에 대해서는 명확하지 않은 상태입니다., 비타민 C의 섭취가 많은 집단의 자궁경부암 발생 빈도가 20~50 %까지 감소한다는 연구 결과가 나온 바 있습니다. 그러나 이후 연구에서 항상 예방 효과가 명확히 보도된 것은 아니었기 때문에 현재 미국암연구협회(American Institute for Cancer Research)에서는 “비타민 C의 다량의 섭취가 자궁경부암의 위험도를 줄일 가능성이 있다”라고 결론을 내렸습니다., 일부 연구에서 비타민 E의 섭취가 많거나 혈중 농도가 높을수록 자궁경부암의 위험도가 낮은 경향을 보이기는 했지만 아직 확실히 결론을 내린 것은 아닙니다. 그러나 혈중 비타민 E의 농도가 자궁경부이형성증(정상조직과 암조직의 중간과정)의 정도가 심할수록 낮았다는 보고가 있으므로 자궁경부암의 예방 효과가 있을 가능성은 존재합니다.",
        sourceIds: ["nccCervicalFoodPrevention"],
      },
      {
