...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 중 올바르게 식사하기 자료는 건강식이 좋은 영양 상태로 치료 참여를 돕고, 치료 부작용 극복과 감염 위험 감소 및 항암치료 후 손상 세포 재생 지원에 좋은 영향을 줄 수 있다고 설명합니다.",
        examples:
          "항암치료 로 손상된 세포의 재생을 도와줍니다., 환자가 좋은 영양 상태로 치료에 적극 참여할 수 있게 해줍니다., 치료에 의한 부작용을 더 잘 극복하게 해줍니다., 감염의 위험을 감소시켜 줍니다.",
        sourceIds: ["nccTreatmentRightEating"],
      },
      {
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 중 건강식을 먹는 요령 자료는 식사가 치료의 보조 요법만큼 중요하다고 설명하며, 규칙적인 아침·점심·저녁 식사, 밥 반 그릇에서 한 그릇 또는 죽 하루 4~5번 이상, 끼니마다 충분한 단백질 반찬, 매끼 두 가지 이상 채소 반찬, 씹거나 삼키기 힘든 경우 다지거나 갈아서 먹기, 과일 하루 한두 번, 우유와 유제품 하루 1컵 이상과 요구르트·두유·치즈 대체, 식용유·참기름·버터 등 기름을 볶음이나 나물 요리 양념으로 쓰는 방법, 양념과 조미료를 적당히 쓰되 너무 맵거나 짜지 않게 요리하는 방법, 국·음료·후식을 적당히 먹는 방법을 안내합니다.",
        examples:
