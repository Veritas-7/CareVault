  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "백혈구 감소 등 면역저하 맥락에서는 음식으로 인한 감염을 줄이기 위해 완전히 익힌 음식, 과일·채소 세척, 손상된 캔이나 녹은 냉동제품 구매 주의, 상온 운반 후 즉시 냉장, 오래 보관한 남은 음식과 곰팡이가 핀 음식 폐기, 저온살균 제품 여부를 확인합니다.",
        examples:
          "생굴, 회, 초밥, 육회, 생조개, 날계란, 덜 익힌 고기, 다진 고기, 씻지 않은 딸기, 딸기 등 꼼꼼히 씻기 어려운 과일, 오래된 남은 음식, 3~4일 지난 남은 음식, 곰팡이가 핀 음식, 곰팡이 핀 음식, 상온 30분 이상 운반, 녹슨 캔, 움푹해진 캔, 냉동제품 녹음, 비살균 우유·주스",
        sourceIds: ["nccImmuneLowDiet"],
      },
    ],
  },
