...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 입안의 건조증 자료는 가까운 장소에 물을 두어 조금씩 자주 마시고, 삼키기 쉽게 하기 위해 음식에 소스나 드레싱을 첨가하여 촉촉하게 하며, 식사 중간에 물이나 음료를 한 모금씩 마시고, 딱딱한 사탕이나 껌으로 침 분비를 도울 수 있다고 안내합니다.",
        examples:
          "가까운 장소에 물을 두어 조금씩 자주 마시도록 합니다. 삼키기 쉽게 하기 위해 음식에 소스나 드레싱을 첨가하여 촉촉하게 합니다. 물 조금씩 자주, 물 한 모금, 소스나 드레싱, 딱딱한 사탕, 껌, 껌 씹기",
