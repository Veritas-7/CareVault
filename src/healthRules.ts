...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 체중변화 자료는 치료과정에서 체중감소가 환자를 허약하게 만들고 암에 대한 저항력과 치료효과 등을 떨어뜨릴 수 있어, 체중감소 예방을 위해 열량과 단백질을 충분히 섭취하도록 안내합니다. 밥·죽을 다양하게 조리하고 감자·고구마·떡·만두·과일주스·과일통조림 같은 간식과 탄수화물이 많이 포함된 간식, 계란·콩·두부·생선·유제품 단백질 예시, 단백질이 많이 포함된 간식 선택과 만두·피자·샌드위치·계란샐러드·카스테라 예시를 제시합니다.",
        examples:
