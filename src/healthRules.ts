  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "식품안전나라는 클로스트리디움 퍼프린젠스균을 토양, 하천과 하수 등 자연계와 사람을 비롯하여 동물(주로 포유동물)의 장관, 분변 및 식품 등에 널리 분포하고, 아포를 형성하는 그람양성 편성혐기성 간균으로 설명합니다. 아포의 발아 시 독소를 생성하며 사람의 식중독에는 주로 A형과 C형이 관여한다고 설명합니다. 원인식품으로 돼지고기, 닭고기, 칠면조고기 등으로 조리한 식품 및 그 가공품인 동물성 단백질식품과 미리 가열 조리된 후 실온에서 5시간이상 방치된 식품을 제시하므로 식품 안전 질문으로 분리합니다. 감염원 및 감염경로로 물, 토양, 하수 등 자연계와 가축과 가금류의 장관에 상재할 수 있고 건강한 사람의 장관에도 존재한다고 설명하므로 퍼프린젠스 문맥의 경로 확인으로만 다룹니다. 예방대책으로 대량 큰 용기 보관은 혐기조건이 될 수 있어 소량씩 용기에 넣어 보관, 부득이하게 남은 음식은 먹기 전에 충분히 가열, 따뜻하게 배식하는 음식은 조리 후 배식까지 60℃ 이상 유지, 차갑게 배식하는 음식은 조리 후 재빨리 식혀 5℃ 이하에서 보관을 안내합니다.",
        examples:
          "클로스트리디움 퍼프린젠스균, 아포의 발아 시 독소를 생성, A형과 C형, 돼지고기, 닭고기, 칠면조고기 등으로 조리한 식품 및 그 가공품인 동물성 단백질식품, 미리 가열 조리된 후 실온에서 5시간이상 방치된 식품, 토양, 하천과 하수 등 자연계, 동물(주로 포유동물)의 장관, 분변 및 식품, 물, 토양, 하수 등 자연계, 가축과 가금류의 장관, 건강한 사람의 장관, 식품을 대량으로 큰 용기에 보관하면 혐기조건이 될 수 있으므로 소량씩 용기에 넣어 보관한다, 부득이하게 남은 음식은 먹기 전에 충분히 가열한 후 섭취하여야 한다, 따뜻하게 배식하는 음식은 조리 후 배식까지 60℃ 이상을 유지해야 하며, 차갑게 배식하는 음식은 조리 후 재빨리 식혀 5℃ 이하에서 보관한다",
        sourceIds: ["foodSafetyKoreaClostridiumPerfringensFoodPoisoning"],
      },
      {
        label: "식품안전나라 클로스트리디움 보툴리늄균 식중독 주의",
        detail:
          "식품안전나라는 클로스트리디움 보툴리늄균을 그람양성의 편성혐기성 간균이며 세포 한쪽 끝에 난 원형의 아포를 형성하는 균으로 설명합니다. A형, B형, E형, 및 F형균이 사람에게 식중독을 일으키고, 독소는 매우 독성이 강하지만 열에 불안정하여 80℃, 20분과 100℃, 1~2분 가열로 파괴된다고 설명하므로 식품 안전 질문으로 분리합니다. 원인식품으로 통조림, 병조림, 레토르트 식품, 식육, 소시지 생선을 제시하고, 통조림, 햄, 소시지, 육제품 소비가 많은 곳에서는 A형, B형 균에 의한 식중독이 많다고 설명합니다. 감염원 및 감염경로 문맥으로 토양, 바다, 개천, 호수, 동물의 분변과 어류, 갑각류의 장관 등에 널리 분포한다고 설명합니다. 환경조건이 혐기적일 때 아포가 발아하여 증식하면서 식중독을 발생시킬 정도의 독소를 생산할 수 있다고 설명합니다. 예방대책으로 채소와 곡물 세척, 신선한 어류 조리, 통조림·병조림 및 기타 저장식품도 반드시 가열 후 섭취하도록 안내합니다.",
        examples:
          "클로스트리디움 보툴리늄균, 그람양성의 편성혐기성 간균, 세포 한쪽 끝에 난 원형의 아포, A형, B형, E형, 및 F형균, 80℃, 20분과 100℃, 1~2분 가열로 파괴, 통조림, 병조림, 레토르트 식품, 식육, 소시지 생선, 통조림, 햄, 소시지, 육제품, 토양, 바다, 개천, 호수, 동물의 분변, 어류, 갑각류의 장관, 환경조건이 혐기적일 때 아포가 발아하여 증식하면서 식중독을 발생시킬 정도의 독소를 생산, 채소와 곡물을 반드시 깨끗이 세척하고 생선 등 어류는 신선한 것으로 조리해야 한다, 통조림·병조림 및 기타 저장식품도 반드시 가열 후 섭취하여야 한다",
        sourceIds: ["foodSafetyKoreaClostridiumBotulinumFoodPoisoning"],
      },
      {
        label: "식품안전나라 장출혈성 대장균 식중독 주의",
        detail:
          "식품안전나라는 병원성 대장균 중 베로독소를 생성해 대장점막에 궤양과 출혈을 유발하는 대장균을 장관출혈성대장균이라고 설명하며, O26, O103, O104, O146, O157 등 혈청형과 대표 균인 대장균 O157:H7을 제시합니다. 대장균 O157:H7의 경우 10~100개의 균으로도 병원성을 나타낼 수 있고, 주요 증상은 설사, 복통, 발열, 구토이며 심하면 출혈성 대장염, 용혈성요독증후군, 혈전성혈소판 감소증 등이 나타날 수 있으므로 식품 안전 질문으로 분리합니다. 환자와 보균자의 분변으로부터 직접·간접으로 오염되는 식품이 원인식품이 될 수 있고, 주요 원인식품으로 햄, 치즈, 소시지, 채소샐러드, 분유, 두부, 음료수, 어패류, 도시락, 급식 등을 제시합니다. 감염원 및 감염경로 문맥으로 환자나 보균자의 분변과 소, 돼지와 개, 고양이 등의 분변에 존재하며, 자연계에서는 하천수와 어패류 등에서 분리 검출되므로 1차 및 2차 오염으로 감염될 수 있다고 설명합니다. 예방대책으로 조리기구(칼, 도마 등) 구분 사용, 생육과 조리된 음식을 구분하여 보관, 다진 고기는 중심부 온도가 75℃ 1분 이상 가열을 안내합니다.",
        examples:
          "장출혈성 대장균, 장관출혈성대장균, 장관출혈성 대장균, 베로독소(verotoxin), 장출혈성 대장균 베로독소, 장관출혈성대장균은 혈청형에 따라 O26, O103, O104, O146, O157 등이 있으며, 장출혈성 대장균 혈청형 O26 O103 O104 O146 O157, 대장균 O157:H7, 대장균 O157:H7의 경우 10~100개의 균으로도 병원성을 나타내며, 장출혈성 대장균 O157:H7 10~100개 균, 주요 증상은 설사, 복통, 발열, 구토, 장출혈성 대장균 설사 복통 발열 구토, 출혈성 대장염, 용혈성요독증후군, 혈전성혈소판 감소증, 환자와 보균자의 분변으로부터 직접·간접으로 오염되는 식품, 장출혈성 대장균 직접 간접 분변 오염 식품, 햄, 치즈, 소시지, 채소샐러드, 분유, 두부, 음료수, 어패류, 도시락, 급식, 환자나 보균자의 분변, 소, 돼지와 개, 고양이 등의 분변, 보균자가 화장실을 비위생적으로 사용할 때, 장출혈성 대장균 비위생적 화장실 사용, 하천수와 어패류 등에서 분리 검출, 1차 및 2차 오염으로 감염될 수 있다, 조리기구(칼, 도마 등) 구분 사용으로 2차 오염을 방지하여야 한다, 생육과 조리된 음식을 구분하여 보관하여야 한다, 다진 고기는 중심부 온도가 75℃ 1분 이상 가열하여야 한다",
        sourceIds: ["foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning"],
      },
      {
        label: "식품안전나라 장염비브리오균 식중독 주의",
        detail:
          "식품안전나라는 장염비브리오균을 해수세균의 일종으로 2~4%의 소금물에서 잘 생육하며 해수온도가 15℃ 이상이 되면 급격히 증식하고, 짧은 쉼표 모양의 형태를 나타낸다고 설명합니다. 원인식품으로 어패류, 생선회, 수산식품(게장, 생선회, 오징어무침, 꼬막무침 등)을 제시하고, 하절기에 근해의 오징어, 문어 등 연체동물과 고등어, 아지 등 어류, 조개 등 패류의 체표, 내장과 아가미 등에 부착해 있다가 근육으로 이행되거나 유통과정 중에 증식할 수 있다고 설명합니다. 또한 어패류의 체표와 내장 및 아가미 등에 부착된 균이 조리한 사람의 손과 기구로부터 다른 식품에 2차 오염될 수 있으므로 식품 안전 질문으로 분리합니다. 예방대책으로 어패류는 수돗물로 잘 씻고, 횟감용 칼, 도마는 구분하여 사용, 오염된 조리 기구 세정·열탕 처리, 가능한 한 생식을 피하고 60℃에서 5분, 55℃에서 10분의 가열로 쉽게 사멸하므로 반드시 식품을 가열한 후 섭취하도록 안내합니다.",
        examples:
          "장염비브리오균, 해수세균, 2~4%의 소금물에서 잘 생육, 해수온도가 15℃ 이상이 되면 급격히 증식, 짧은 쉼표 모양, 어패류, 생선회, 수산식품(게장, 생선회, 오징어무침, 꼬막무침 등), 하절기 근해, 체표, 내장과 아가미, 근육으로 이행, 유통과정 중에 증식, 손과 기구로부터 다른 식품에 2차 오염, 어패류의 체표와 내장 및 아가미 등에 부착, 어패류는 수돗물로 잘 씻고, 횟감용 칼, 도마는 구분하여 사용하여야 한다, 오염된 조리 기구는 세정, 열탕 처리하여 2차 오염을 방지하여야 한다, 가능한 한 생식을 피하고, 이 균은 60℃에서 5분, 55℃에서 10분의 가열로 쉽게 사멸하므로 반드시 식품을 가열한 후 섭취한다",
        sourceIds: ["foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning"],
      },
      {
        label: "식품안전나라 리스테리아 식중독 주의",
        detail:
          "식품안전나라는 리스테리아균이 냉장온도에서도 생존하여 증식할 수 있다고 설명합니다. 원인식품으로 원유, 살균처리하지 아니한 우유, 핫도그, 치즈(특히 소프트치즈), 아이스크림, 소시지 및 건조 소시지, 가공·비가공 가금육, 비가공 식육 등 식육제품과 비가공·훈연생성 및 채소류를 제시합니다. 감염원 및 감염경로 문맥으로 부적절한 축산제품의 취급·처리 및 적절하지 못한 물의 사용(재배·처리) 등으로 오염되며 자연환경에 널리 분포되어 있다고 설명하고, 고염농도와 저온상태의 환경에서도 잘 적응하여 성장한다고 안내하므로, 면역저하 또는 항암 치료 중 식품 메모에서는 냉장 보관 온도 5℃ 이하 관리와 살균 안 된 우유 회피를 식품 안전 질문으로 분리합니다.",
        examples:
          "리스테리아균, 냉장온도에서도 생존하여 증식, 원유, 살균처리하지 아니한 우유, 살균 안 된 우유를 섭취하지 말아야 한다, 핫도그, 치즈(특히 소프트치즈), 아이스크림, 소시지 및 건조 소시지, 가공·비가공 가금육, 비가공 식육, 식육제품, 비가공·훈연생성 및 채소류, 부적절한 축산제품의 취급·처리, 적절하지 못한 물의 사용(재배·처리), 자연환경에 널리 분포, 고염농도, 저온상태의 환경, 고염농도, 저온상태의 환경에서도 잘 적응하여 성장, 냉장 보관 온도(5℃ 이하) 관리를 철저하게 하여야 한다",
        sourceIds: ["foodSafetyKoreaListeriaFoodPoisoning"],
      },
      {
        label: "식품안전나라 여시니아 엔테로콜리티카균 식중독 주의",
        detail:
          "식품안전나라는 여시니아 엔테로콜리티카균을 운동성이 있는 그람음성 단간균이며 다른 장내세균은 증식할 수 없는 0~5℃의 냉장고에서도 발육이 가능한 전형적인 저온세균으로 설명합니다. 진공포장에서도 증식할 수 있는 특성과 저온발육 특성 때문에 가을과 초겨울철 식품 취급·보존에 방심할 수 있다고 설명하고, 오물, 오염된 물, 돼지고기, 양고기, 쇠고기, 생우유, 아이스크림을 주요 원인식품으로 제시하므로 식품 안전 질문으로 분리합니다. 감염원 및 감염경로 문맥으로 도살된 돼지와 소 등의 육류가 감염원이고, 쥐가 균을 매개하기도 하며, 동물의 분변과 함께 배출되어 음료수나 식품에 오염되는 것으로 추정된다고 설명합니다. 예방대책으로 돈육 취급 시 조리기구와 손을 깨끗이 세척·소독하고, 저온보관 상태에서도 균이 증식하며 0℃에서도 증식이 가능한 점을 고려해 냉장 및 냉동육과 그 제품의 유통과정에서도 주의하도록 안내합니다.",
        examples:
          "여시니아 엔테로콜리티카균, 0~5℃의 냉장고에서도 발육이 가능한, 진공포장에서도 증식할 수 있는 특성, 오물, 오염된 물, 돼지고기, 양고기, 쇠고기, 생우유, 아이스크림, 도살된 돼지와 소 등의 육류, 쥐가 균을 매개, 동물의 분변과 함께 배출되어 음료수나 식품에 오염, 저온보관 상태에서도 균이 증식, 돈육 취급 시 조리기구와 손을 깨끗이 세척·소독한다, 저온에서 생육이 억제되지 않으며 균이 0℃에서도 증식이 가능한 점을 고려할 때 냉장 및 냉동육과 그 제품의 유통과정에서도 주의하여야 한다",
        sourceIds: ["foodSafetyKoreaYersiniaEnterocoliticaFoodPoisoning"],
      },
      {
        label: "식품안전나라 캠필로박터 식중독 주의",
        detail:
          "식품안전나라는 캠필로박터균의 원인식품으로 소, 돼지, 개, 고양이, 닭, 우유, 물을 제시하고, 육류의 생식이나 불충분한 가열, 동물(조류 등)의 분변에 의한 오염을 감염 경로로 설명합니다. 감염원 및 감염경로 문맥으로 건강한 소, 양, 개와 닭, 칠면조 등 가금류의 장내와 인간의 배설물 속에 존재할 수 있고, 오염분뇨가 하천수와 호수 등을 오염시키거나 가축과 가금류를 도살·해체 할 때 식육에 오염될 수 있다고 설명합니다. 생육을 만진 경우 손을 깨끗하게 씻고 소독해 2차 오염을 막고, 식품은 충분히 가열하며, 마시는 물도 끓여 마시고, 식육(특히 닭고기)의 생식을 피하며, 열이나 건조에 약하므로 조리 기구는 물로 끓이거나 소독하여 건조하도록 안내합니다.",
        examples:
          "캠필로박터균, 소, 돼지, 개, 고양이, 닭, 우유, 물, 육류의 생식이나 불충분한 가열, 동물(조류 등)의 분변에 의한 오염, 인간의 배설물, 오염분뇨가 하천수와 호수 등을 오염, 가축과 가금류를 도살·해체 할 때 식육에 오염, 생육을 만진 경우 손을 깨끗하게 씻고 소독하여 2차 오염 방지하여야 한다, 마시는 물도 끓여 마셔야 한다, 식육(특히 닭고기)의 생식, 조리 기구는 물로 끓이거나 소독하여 건조시켜야 한다",
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 암경험자 건강관리 가이드는 식품 안전을 위해 식사 전 손을 씻고 조리 시 손과 모든 식재료를 씻으며, 날 생선·육류·계란을 주의하고, 육류·생선을 완전히 익히며, 음식은 4℃ 이하에서 보관하도록 안내합니다. 외식할 때 박테리아가 있을 수 있는 샐러드 바·회·생선 초밥·덜 익힌 고기나 생선·해산물이나 계란은 피한다고 안내합니다. 우유나 주스, 꿀은 멸균처리 된 것을 이용하고 물은 끓여서 먹도록 제시합니다. 건강보조식품은 암 재발위험을 낮추거나 생존 가능성을 높인다는 증거가 없고, 복용 전 실제 영양소 결핍 평가가 더 중요하며, 항암화학 또는 방사선치료 중 항산화제는 특별한 상황에서 주치의가 권장하는 경우를 제외하고 일일 권장량 이상 섭취를 피해야 한다고 안내하므로 진료팀 확인 후보로 분리합니다.",
        examples:
          "식사 전에는 비누와 물을 이용해 손을 깨끗이 씻는다., 조리 시에는 손을 잘 씻고 모든 식 재료들도 깨끗이 씻는다., 날 생선이나 육류,계란은 주의한다., 육류와 생선은 완전히 익혀 조리한다., 세균의 증식을 막기 위해 음식은 4℃ 이하에서 보관한다., 외식할 때는 박테리아가 있을 수 있는 음식들(샐러드 바, 회, 생선 초밥, 덜 익힌 고기나 생선, 해산물이나 계란)은 피한다., 우유나 주스, 꿀 같은 음식은 멸균처리 된 것을 이용한다., 물은 끓여서 먹는다., 암경험자 식사 전 손 씻기, 암경험자 식재료 세척, 암경험자 날 생선 육류 계란 주의, 암경험자 육류와 생선 완전가열, 암경험자 음식 4도 이하 보관, 암경험자 멸균처리 우유, 암경험자 멸균처리 주스, 암경험자 멸균처리 꿀, 암경험자 물 끓여서 먹기, 건강보조식품의 복용이 암 재발위험을 낮추거나 암 생존 가능성을 높인다는 증거는 없습니다., 건강보조식품을 복용하기 전에 실제로 특정 영양소가 결핍된 상태인지 평가하는 것이 더 중요합니다., 항암화학 또는 방사선치료, 일일 권장량 이상의 항산화제, 암경험자 건강보조식품 재발위험 근거 없음, 암경험자 영양소 결핍 평가 후 건강보조식품, 암경험자 항암화학치료 중 항산화제, 암경험자 방사선치료 중 항산화제",
        sourceIds: ["nccCancerSurvivorHealthGuide"],
      },
      {
        label: "CDC 면역저하자 새싹채소·자른 멜론·재가열 확인",
        detail:
          "CDC는 항암화학요법이나 방사선치료를 받는 경우 면역저하 상태일 수 있고, 면역저하자는 식중독 위험이 더 높다고 설명합니다. 채소와 과일 선택에서는 생 또는 덜 익힌 새싹채소, 세척하지 않은 신선 과일·채소, 자른 멜론을 2시간 넘게 상온에 둔 경우(고온 노출 시 1시간)를 위험 선택으로 분리하고, 익힌 새싹채소와 씻은 채소·과일, 자른 직후의 멜론 또는 자른 멜론 냉장 보관 7일 이하를 더 안전한 선택으로 제시합니다. 육류 선택에서는 데우지 않은 델리미트, 콜드컷, 핫도그, 발효 또는 건조 소시지를 위험 선택으로 분리하고, 같은 식품을 165°F 또는 김이 날 때까지 데운 경우를 더 안전한 선택으로 제시합니다. 앱에서는 모든 새싹채소·멜론·가공육을 금지하지 않고, 최근 WBC/ANC·항암·방사선 일정과 함께 생식·덜 익힘·상온 방치·재가열 여부를 진료팀에 확인할 기록 후보로 사용합니다.",
        examples:
          "항암화학요법이나 방사선치료를 받는 경우, 생 또는 덜 익힌 새싹채소, 생 새싹채소, 덜 익힌 새싹채소, 생 알팔파 새싹, 생 숙주, 덜 익힌 콩나물, 자른 멜론을 2시간 넘게 상온에 둔 경우, 자른 멜론 2시간 이상 상온, 자른 멜론 1시간 이상 고온, 익힌 새싹채소, 익힌 숙주, 익힌 콩나물, 자른 멜론 냉장 보관 7일 이하, 데우지 않은 델리미트, 데우지 않은 콜드컷, 데우지 않은 핫도그, 데우지 않은 발효 소시지, 데우지 않은 건조 소시지, 델리미트 165°F 재가열, 콜드컷 김이 날 때까지 데우기, 핫도그 김이 날 때까지 데우기, 건조 소시지 165°F 재가열",
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 조혈모세포이식 자료는 `면역억제 시 제한하는 식품과 허용하는 식품` 표를 제시합니다. 같은 무균실 수액 및 영양관리 문맥에서는 면역력 감소 시 완전 조리된 음식(통조림, 병조림, 캔음료수, 멸균우유, 두유 등), 집에서 만든 음식, 진공 포장된 음식을 먹도록 하고, 익히지 않은 생과일, 생야채, 어육류, 치즈는 피한다고 안내합니다. 제한 식품 예시에는 살균처리되지 않은 생우유, 아이스크림, 유산균발효유, 천연치즈, 생과일, 냉동과일, 마른과일, 마른과일(건포도, 건대추)이 들어간 빵, 생채소, 끓이지 않은 물, 핫칠리소스, 후추, 생된장, 허브, 생꿀, 포장되지 않은 제빵류, 익히지 않은 어육류(생선회, 육회), 껍질에 금이 간 계란, 조개류, 오징어, 훈제연어, 젓갈, 베이컨, 핫도그, 햄, 소시지, 런천미트(완전히 익힌 것은 허용), 내장류, 숙성치즈, 날계란이 들어간 샐러드 드레싱, 효모 건강보조식품, 유효날짜 없는 식품, 색이나 냄새가 이상한 모든 식품, 파손된 용기의 식품 등이 있고, 허용 식품 예시에는 익힌 곡류(빵, 밥, 비스켓 등), 멸균우유, 멸균두유, 과일 통조림, 캔쥬스, 완전히 익힌 채소류, 식용유, 버터, 마가린, 포장된 제빵류, 완전히 익힌 어육류 및 난류, 두부, 완전히 익힌 육가공품, 겨자, 간장, 케찹, 마요네즈, 잼, 젤리, 사탕, 멸균 처리된 상업용 포장꿀, 캔으로 판매되는 음료 등이 있습니다. 이 항목은 조혈모세포이식이나 면역억제 상황의 식품표 확인으로만 사용하고, 전체 환자 식단 규칙이나 치료식 주장으로 과장하지 않습니다.",
        examples:
          "면역억제 시 제한하는 식품과 허용하는 식품, 면역억제 생과일, 면역억제 생채소, 면역억제 끓이지 않은 물, 면역억제 생꿀, 면역억제 천연치즈, 면역억제 익히지 않은 생과일, 면역억제 익히지 않은 생야채, 면역억제 익히지 않은 어육류, 면역억제 익히지 않은 치즈, 면역억제 살균처리되지 않은 생우유, 면역억제 아이스크림, 면역억제 유산균발효유, 면역억제 냉동과일, 면역억제 마른과일, 면역억제 마른과일이 들어간 빵, 면역억제 건포도 빵, 면역억제 건대추 빵, 면역억제 핫칠리소스, 면역억제 후추, 면역억제 생된장, 면역억제 허브, 면역억제 포장되지 않은 제빵류, 면역억제 생선회, 면역억제 육회, 면역억제 껍질에 금이 간 계란, 면역억제 조개류, 면역억제 오징어, 면역억제 훈제연어, 면역억제 젓갈, 면역억제 베이컨, 면역억제 핫도그, 면역억제 햄, 면역억제 소시지, 면역억제 런천미트, 면역억제 유효날짜 없는 식품, 면역억제 색이나 냄새가 이상한 식품, 면역억제 파손된 용기의 식품, 면역억제 내장류, 면역억제 숙성치즈, 면역억제 날계란이 들어간 샐러드 드레싱, 면역억제 효모 건강보조식품, 면역억제 완전 조리된 음식, 면역억제 통조림, 면역억제 병조림, 면역억제 캔음료수, 면역억제 집에서 만든 음식, 면역억제 진공 포장된 음식, 면역억제 익힌 곡류, 면역억제 익힌 빵, 면역억제 익힌 밥, 면역억제 익힌 비스켓, 면역억제 멸균우유, 면역억제 멸균두유, 면역억제 과일 통조림, 면역억제 완전히 익힌 채소류, 면역억제 캔쥬스, 면역억제 식용유, 면역억제 버터, 면역억제 마가린, 면역억제 포장된 제빵류, 면역억제 완전히 익힌 어육류, 면역억제 완전히 익힌 난류, 면역억제 두부, 면역억제 완전히 익힌 육가공품, 면역억제 완전히 익힌 햄, 면역억제 겨자, 면역억제 간장, 면역억제 케찹, 면역억제 마요네즈, 면역억제 잼, 면역억제 젤리, 면역억제 사탕, 면역억제 멸균 처리된 상업용 포장꿀, 면역억제 캔으로 판매되는 음료",
...
const supportiveFoods: FoodRuleTerm[] = [
  ...
  [
    "델리미트 165°F 재가열",
    "CDC 면역저하자 식품안전 델리미트·핫도그 재가열 후보",
    "cdcWeakenedImmuneFoodSafety",
  ],
  [
    "콜드컷 김이 날 때까지 데우기",
...
const careTeamFoods: FoodRuleTerm[] = [
  ...
  [
    ...
    "국가암정보센터 암경험자 식품안전 멸균·끓인 물 확인 필요",
    "nccCancerSurvivorHealthGuide",
  ],
  [
    "물은 끓여서 먹는다.",
  ...
  [
    ...
    "국가암정보센터 암경험자 식품안전 위생·가열·냉장 확인 필요",
    "nccCancerSurvivorHealthGuide",
  ],
  [
  ...
  [
    "살모넬라 하수",
    "식품안전나라 살모넬라균 하수 자연환경 감염경로 확인 필요",
    "foodSafetyKoreaSalmonellaFoodPoisoning",
  ],
  [
    "살모넬라 하천수",
    "식품안전나라 살모넬라균 하천수 자연환경 감염경로 확인 필요",
    "foodSafetyKoreaSalmonellaFoodPoisoning",
  ],
  [
    "살모넬라 가축",
    "식품안전나라 살모넬라균 가축 감염원·감염경로 확인 필요",
    "foodSafetyKoreaSalmonellaFoodPoisoning",
  ],
  [
    "살모넬라 가금",
    "식품안전나라 살모넬라균 가금 감염원·감염경로 확인 필요",
    "foodSafetyKoreaSalmonellaFoodPoisoning",
  ],
  [
    "살모넬라 가금류",
    "식품안전나라 살모넬라균 가금류 감염원·감염경로 확인 필요",
    "foodSafetyKoreaSalmonellaFoodPoisoning",
  ],
  [
    "살모넬라 개",
  ...
  [
    "바실러스 김밥",
    "식품안전나라 바실러스 세레우스균 김밥 같은 식품 조리 후 즉시 섭취 확인 필요",
    "foodSafetyKoreaBacillusCereusFoodPoisoning",
  ],
  [
    "바실러스 볶음밥",
  ...
  [
    "퍼프린젠스 물",
    "식품안전나라 클로스트리디움 퍼프린젠스균 물 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 토양",
    "식품안전나라 클로스트리디움 퍼프린젠스균 토양 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 하천",
    "식품안전나라 클로스트리디움 퍼프린젠스균 하천 자연계 분포 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 하수",
    "식품안전나라 클로스트리디움 퍼프린젠스균 하수 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 동물 장관",
    "식품안전나라 클로스트리디움 퍼프린젠스균 동물 장관 분포 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 포유동물 장관",
    "식품안전나라 클로스트리디움 퍼프린젠스균 포유동물 장관 분포 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 분변",
    "식품안전나라 클로스트리디움 퍼프린젠스균 분변 분포 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 식품",
    "식품안전나라 클로스트리디움 퍼프린젠스균 식품 분포 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 가축",
    "식품안전나라 클로스트리디움 퍼프린젠스균 가축 장관 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 가금류",
    "식품안전나라 클로스트리디움 퍼프린젠스균 가금류 장관 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 건강한 사람 장관",
    "식품안전나라 클로스트리디움 퍼프린젠스균 건강한 사람 장관 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 사람 장관",
    "식품안전나라 클로스트리디움 퍼프린젠스균 사람 장관 감염원·감염경로 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 돼지고기 조리식품",
  ...
  [
    "퍼프린젠스 동물성 단백질식품",
    "식품안전나라 클로스트리디움 퍼프린젠스균 동물성 단백질식품 원인식품 확인 필요",
    "foodSafetyKoreaClostridiumPerfringensFoodPoisoning",
  ],
  [
    "퍼프린젠스 5시간 실온방치 식품",
  ...
  [
    "보툴리늄 햄",
    "식품안전나라 클로스트리디움 보툴리늄균 햄 소비 문맥 확인 필요",
    "foodSafetyKoreaClostridiumBotulinumFoodPoisoning",
  ],
  [
    "보툴리늄 소시지",
  ...
  [
    "보툴리늄 육제품",
    "식품안전나라 클로스트리디움 보툴리늄균 육제품 소비 문맥 확인 필요",
    "foodSafetyKoreaClostridiumBotulinumFoodPoisoning",
  ],
  [
    "보툴리늄 생선",
  ...
  [
    "베로독소(verotoxin)",
    "식품안전나라 장출혈성 대장균 베로독소 생성 특성 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 베로독소",
    "식품안전나라 장출혈성 대장균 베로독소 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장관출혈성대장균은 혈청형에 따라 O26, O103, O104, O146, O157 등이 있으며",
    "식품안전나라 장출혈성 대장균 공식 혈청형 목록 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 혈청형 O26 O103 O104 O146 O157",
    "식품안전나라 장출혈성 대장균 혈청형 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "대장균 O157:H7",
  ...
  [
    ...
    "식품안전나라 장출혈성 대장균 O157:H7 소량 병원성 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 O157:H7 10~100개 균",
    "식품안전나라 장출혈성 대장균 O157:H7 10~100개 균 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "주요 증상은 설사, 복통, 발열, 구토",
    "식품안전나라 장출혈성 대장균 주요 증상 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 설사 복통 발열 구토",
    "식품안전나라 장출혈성 대장균 증상 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
  ...
  [
    ...
    "식품안전나라 장출혈성 대장균 직접·간접 분변 오염 식품 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 직접 간접 분변 오염 식품",
    "식품안전나라 장출혈성 대장균 직접 간접 분변 오염 식품 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "환자나 보균자의 분변",
  ...
  [
    "소, 돼지와 개, 고양이 등의 분변",
    "식품안전나라 장출혈성 대장균 동물 분변 오염 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 동물 분변",
    "식품안전나라 장출혈성 대장균 동물 분변 오염 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
  ...
  [
    ...
    "식품안전나라 장출혈성 대장균 비위생적 화장실 사용 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "하천수와 어패류 등에서 분리 검출",
  ...
  [
    "장출혈성 대장균 하천수",
    "식품안전나라 장출혈성 대장균 하천수 분리 검출 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 2차 오염",
    "식품안전나라 장출혈성 대장균 2차 오염 문맥 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 햄",
  ...
  [
    "장출혈성 대장균 채소 샐러드",
    "식품안전나라 장출혈성 대장균 채소 샐러드 원인식품 확인 필요",
    "foodSafetyKoreaEnterohemorrhagicEcoliFoodPoisoning",
  ],
  [
    "장출혈성 대장균 분유",
  ...
  [
    "장염비브리오 오징어",
    "식품안전나라 장염비브리오균 오징어 오염경로 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 문어",
    "식품안전나라 장염비브리오균 문어 오염경로 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 연체동물",
  ...
  [
    "장염비브리오 조개",
    "식품안전나라 장염비브리오균 조개 오염경로 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 패류",
    "식품안전나라 장염비브리오균 패류 오염경로 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
  ...
  [
    "장염비브리오 해수세균",
    "식품안전나라 장염비브리오균 해수세균 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 하절기 근해",
    "식품안전나라 장염비브리오균 하절기 근해 오염경로 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 체표",
    "식품안전나라 장염비브리오균 체표 부착 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 내장",
    "식품안전나라 장염비브리오균 내장 부착 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 아가미",
    "식품안전나라 장염비브리오균 아가미 부착 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 근육 이행",
    "식품안전나라 장염비브리오균 근육 이행 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 유통과정 증식",
    "식품안전나라 장염비브리오균 유통과정 증식 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "장염비브리오 손 기구 2차 오염",
    "식품안전나라 장염비브리오균 손·기구 2차 오염 문맥 확인 필요",
    "foodSafetyKoreaVibrioParahaemolyticusFoodPoisoning",
  ],
  [
    "노로바이러스 식중독",
  ...
  [
    "식육제품과 비가공·훈연생성 및 채소류",
    "식품안전나라 리스테리아 식중독 식육제품·비가공 훈연생선·채소류 원인식품 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 식육제품",
    "식품안전나라 리스테리아 식중독 식육제품 원인식품 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 비가공·훈연생성",
    "식품안전나라 리스테리아 식중독 비가공·훈연생성 원인식품 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 훈연생선",
    "식품안전나라 리스테리아 식중독 훈연생선 원인식품 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 채소류",
    "식품안전나라 리스테리아 식중독 채소류 원인식품 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "부적절한 축산제품의 취급·처리 및 적절하지 못한 물의 사용",
    "식품안전나라 리스테리아 식중독 축산제품 취급·처리와 재배·처리 물 오염경로 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 자연환경",
    "식품안전나라 리스테리아 식중독 자연환경 분포 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 축산제품 취급·처리",
    "식품안전나라 리스테리아 식중독 축산제품 취급·처리 오염경로 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 적절하지 못한 물 사용",
    "식품안전나라 리스테리아 식중독 재배·처리 물 오염경로 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 재배·처리 물",
    "식품안전나라 리스테리아 식중독 재배·처리 물 사용 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 고염농도",
    "식품안전나라 리스테리아 식중독 고염농도 환경 성장 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "리스테리아 저온상태",
    "식품안전나라 리스테리아 식중독 저온상태 환경 성장 확인 필요",
    "foodSafetyKoreaListeriaFoodPoisoning",
  ],
  [
    "여시니아 엔테로콜리티카균",
  ...
  [
    "도살된 돼지와 소 등의 육류",
    "식품안전나라 여시니아 엔테로콜리티카균 도살 육류 감염원 확인 필요",
    "foodSafetyKoreaYersiniaEnterocoliticaFoodPoisoning",
  ],
  [
    "여시니아 도살된 돼지",
    "식품안전나라 여시니아 엔테로콜리티카균 도살된 돼지 감염원 확인 필요",
    "foodSafetyKoreaYersiniaEnterocoliticaFoodPoisoning",
  ],
  [
    "여시니아 도살된 소",
    "식품안전나라 여시니아 엔테로콜리티카균 도살된 소 감염원 확인 필요",
    "foodSafetyKoreaYersiniaEnterocoliticaFoodPoisoning",
  ],
  [
    "여시니아 쥐 매개",
    "식품안전나라 여시니아 엔테로콜리티카균 쥐 매개 감염경로 확인 필요",
    "foodSafetyKoreaYersiniaEnterocoliticaFoodPoisoning",
  ],
  [
    "여시니아 동물 분변",
  ...
  [
    "캠필로박터 개",
    "식품안전나라 캠필로박터 식중독 개 원인식품 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
    standaloneFoodTermOptions,
  ],
  [
    "캠필로박터 고양이",
    "식품안전나라 캠필로박터 식중독 고양이 원인식품 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "캠필로박터 양",
    "식품안전나라 캠필로박터 식중독 양 장내·오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
    standaloneFoodTermOptions,
  ],
  [
  ...
  [
    "캠필로박터 가금류",
    "식품안전나라 캠필로박터 식중독 가금류 장내·도살 해체 오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "캠필로박터 칠면조",
    "식품안전나라 캠필로박터 식중독 칠면조 장내·도살 해체 오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "캠필로박터 가축",
  ...
  [
    "캠필로박터 인간 배설물",
    "식품안전나라 캠필로박터 식중독 인간 배설물 오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "캠필로박터 오염분뇨",
    "식품안전나라 캠필로박터 식중독 오염분뇨 하천수·호수 오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "캠필로박터 도살·해체 식육 오염",
    "식품안전나라 캠필로박터 식중독 도살·해체 중 식육 오염경로 확인 필요",
    "foodSafetyKoreaCampylobacterFoodPoisoning",
  ],
  [
    "육류의 생식이나 불충분한 가열",
  ...
  [
    "데우지 않은 델리미트",
    "CDC 면역저하자 식품안전 데우지 않은 델리미트·핫도그 확인 필요",
    "cdcWeakenedImmuneFoodSafety",
  ],
  [
    "데우지 않은 콜드컷",
