...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 체중변화 자료는 치료과정에서 체중감소가 환자를 허약하게 만들고 암에 대한 저항력과 치료효과 등을 떨어뜨릴 수 있어, 체중감소 예방을 위해 열량과 단백질을 충분히 섭취하도록 안내합니다. 밥·죽을 다양하게 조리하고 감자·고구마·떡·만두·과일주스·과일통조림 같은 간식과 계란·콩·두부·생선·유제품 단백질 예시를 제시합니다.",
        examples:
          "암환자는 치료과정에서 체중의 감소를 흔하게 경험할 수 있습니다. 체중감소는 환자를 허약하게 만들고 암에 대한 저항력과 치료효과 등을 떨어뜨립니다. 그러므로 체중감소를 예방하기 위해서 열량과 단백질 등을 충분히 섭취해야 합니다.; 체중감소 김밥, 체중감소 주먹밥, 체중감소 야채죽, 체중감소 전복죽, 체중감소 계란죽, 체중감소 잣죽, 체중감소 감자, 체중감소 고구마, 체중감소 떡, 체중감소 만두, 체중감소 과일주스, 체중감소 과일통조림, 체중감소 땅콩버터, 체중감소 계란찜, 체중감소 두유, 체중감소 두부조림, 체중감소 생선전, 체중감소 어묵, 체중감소 요구르트",
        sourceIds: ["nccWeightChangeDiet"],
      },
      {
        label: "체중증가 시 균형 식품 선택",
        detail:
          "국가암정보센터 체중변화 자료는 체중증가 원인을 의료진과 확인한 뒤 체중조절 방법으로 과일·야채·곡류 섭취를 늘리고, 가능한 한 지방이 없는 부위의 육류제품과 저지방 우유 및 유제품을 이용하도록 안내합니다.",
        examples:
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 입과 목의 통증 자료는 부드럽고 촉촉한 음식을 준비하고, 씹고 삼키기 쉬운 음식으로 죽류·미음·부드럽게 조리한 고기·생선·데친 채소·시지 않은 과일을 예시로 들며, 요리는 부드럽고 연해질 때까지 하고 음식을 작은 크기로 자르거나 경우에 따라 믹서로 곱게 갈도록 안내합니다. 얼음조각도 도움이 될 수 있지만, 옥살로플라틴 등 온도변화에 민감해질 수 있는 항암제를 투여 받는 경우에는 차가운 음식을 피하도록 안내합니다.",
        examples:
          "부드럽고 촉촉한 음식을 준비합니다. 씹고 삼키기 쉬운 음식을 먹습니다. 요리를 할 때는 부드럽고 연해질 때까지 하도록 하며, 음식을 작은 크기로 자릅니다. 경우에 따라서는 믹서로 곱게 갈도록 합니다. 얼음조각을 먹는 것도 도움이 됩니다. 흰죽, 닭죽, 고기죽, 전복죽, 호박죽, 야채죽, 계란죽, 쌀미음, 조미음, 잣미음, 깨미음, 녹두미음, 부드러운 야채, 데친 채소, 바나나, 배, 수박, 과일통조림",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "입안을 자극하는 음식이나 음료는 피하도록 합니다. 뜨거운 음식은 입과 목을 자극하므로 차거나 상온의 음식을 이용합니다. 토마토주스, 토스트, 크래커, 말린 음식, 오렌지, 포도, 레몬, 향신료를 많이 사용한 음식, 소금에 절인 음식",
        sourceIds: ["nccMouthPainDiet"],
      },
      {
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 체중변화 자료는 체중증가 원인을 먼저 의사와 확인하도록 하며, 항암제 관련 수분 보유가 의심되면 가공식품·김치·젓갈·장아찌류 같은 염분 함량이 높은 식품을 제한하고, 식욕 증가가 있으면 청량 음료·초콜릿·사탕·과자류처럼 열량이 높고 영양가가 낮은 식품을 제한하도록 안내합니다. 체중조절 방법으로 버터, 마요네즈, 감미료 등을 추가로 사용하지 않고 가능한 고열량의 간식은 먹지 않도록 안내합니다.",
        examples:
          "버터, 마요네즈, 감미료 등을 추가로 사용하지 않도록 합니다.; 가능한 고열량의 간식은 먹지 않도록 합니다.; 체중증가 가공식품, 체중증가 김치, 체중증가 젓갈, 체중증가 장아찌류, 체중증가 청량 음료, 체중증가 초콜릿, 체중증가 사탕, 체중증가 과자류, 체중증가 고열량 간식",
        sourceIds: ["nccWeightChangeDiet"],
      },
      {
        label: "가당 유제품",
