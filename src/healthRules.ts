  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "입안을 자극하는 음식이나 음료는 피하도록 합니다. 오렌지, 포도, 레몬, 토마토주스. 향신료를 많이 사용하거나 소금에 절인 음식. 뜨거운 음식은 입과 목을 자극하므로 차거나 상온의 음식을 이용합니다. 토마토주스, 토스트, 크래커, 말린 음식, 오렌지, 포도, 레몬, 향신료를 많이 사용한 음식, 소금에 절인 음식",
        sourceIds: ["nccMouthPainDiet"],
      },
      {
