...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 입과 목의 통증 자료는 부드럽고 촉촉한 음식을 준비하고, 씹고 삼키기 쉬운 음식으로 죽류·미음·부드럽게 조리한 고기·생선·데친 채소·시지 않은 과일을 예시로 들며, 요리는 부드럽고 연해질 때까지 하고 음식을 작은 크기로 자르거나 경우에 따라 믹서로 곱게 갈도록 안내합니다.",
        examples:
          "부드럽고 촉촉한 음식을 준비합니다. 씹고 삼키기 쉬운 음식을 먹습니다. 요리를 할 때는 부드럽고 연해질 때까지 하도록 하며, 음식을 작은 크기로 자릅니다. 경우에 따라서는 믹서로 곱게 갈도록 합니다. 흰죽, 닭죽, 고기죽, 전복죽, 호박죽, 야채죽, 계란죽, 쌀미음, 조미음, 잣미음, 깨미음, 녹두미음, 부드러운 야채, 데친 채소, 바나나, 배, 수박, 과일통조림",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "입안 자극 음식",
        detail:
          "국가암정보센터 입과 목의 통증 자료는 입안을 자극하는 음식이나 음료를 피하도록 하며, 오렌지·포도·레몬·토마토주스, 향신료를 많이 사용하거나 소금에 절인 음식, 토스트·크래커·말린 음식은 통증 상황에서 피하도록 안내합니다.",
        examples:
          "입안을 자극하는 음식이나 음료는 피하도록 합니다. 토마토주스, 토스트, 크래커, 말린 음식, 오렌지, 포도, 레몬, 향신료를 많이 사용한 음식, 소금에 절인 음식",
        sourceIds: ["nccMouthPainDiet"],
      },
      {
