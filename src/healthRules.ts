...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "유통기한 꼭 확인, 신선도 유지, 대량 구입하지 않기, 소량씩 구입, 직접 갈아주는 곳에서 구입",
      ...
      },
      {
        ...
        examples:
          "상하기 쉬운 음식은 냉장고, 혹은 냉동고에 보관합니다, 상하기 쉬운 음식 냉장고 냉동고 보관, 요리하기 전의 고기 생선 닭고기 분리 보관, 고기나 생선즙이 떨어지지 않도록 보관, 고기는 냉장고에서 녹입니다, 냉동고에 식품을 보관할 때는 랩이나 팩에 포장합니다, 냉동고 식품 랩이나 팩 포장, 해동한 후 즉시 요리하는 것이 좋습니다, 해동한 후 즉시 요리, 남은 음식은 포장하여 즉시 냉장 보관합니다, 남은 음식 즉시 냉장 보관",
        sourceIds: ["nccImmuneLowDiet"],
      },
      {
        ...
        examples:
          "채소와 과일 먹기 전 세척, 과일이나 채소 썰기 전 세척",
        sourceIds: ["nccImmuneLowDiet"],
      },
      {
      ...
      },
      {
        ...
        examples:
          "고기 닭고기 생선 완전히 익히기, 고기 닭고기 생선 등은 완전히 익히기, 갈아둔 고기 충분히 익히기, 다른 재료들과 섞기 전에 충분히 익히기",
        sourceIds: ["nccImmuneLowDiet"],
      },
      {
        label: "면역저하 조리 위생 후보",
        ...
        examples:
          "음식을 만지거나 요리를 하려면 손을 깨끗이 씻도록 합니다, 손톱 밑부분까지 깨끗이 씻도록 합니다, 손톱 밑까지 깨끗이 씻기, 음식물에 머리카락이 들어가지 않도록 합니다, 음식물에 머리카락 들어가지 않게, 조리에 사용되는 기구, 식기, 수저는 반드시 소독합니다, 조리 기구 식기 수저 소독, 고기, 생선, 과일, 채소 등에 사용되는 식기, 도마, 칼 등은 가능한 분리해서 사용하거나 소독한 다음 사용합니다, 식기 도마 칼 분리 사용, 생고기, 닭고기, 생선 등에서 나오는 즙이 다른 식품이나 음식에 떨어지지 않도록 조심합니다, 생고기 닭고기 생선 즙이 다른 식품에 떨어지지 않게, 외식보다는 직접 요리",
        sourceIds: ["nccImmuneLowDiet"],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "생굴, 회, 육회, 생선회, 생조개, 초밥 등 익히지 않은 음식은 드시지 않습니다, 날계란, 덜 익힌 고기, 날계란이나 덜 익힌 계란이 들어간 음식, 다진 고기, 가는 과정에서 오염 가능, 씻지 않은 딸기, 딸기 등 꼼꼼히 씻기 어려운 과일, 오래된 남은 음식, 3~4일 지난 남은 음식, 냉장고에 보관하던 남은 음식도 3~4일이 지나면 버립니다, 곰팡이가 핀 음식, 곰팡이 핀 음식, 상한 음식, 식품의 냄새가 이상하거나 모양이 이상한 경우에는 절대 사용하지 않습니다, 상온 30분 이상 운반, 30분 이상 상온에서 운반, 녹슨 캔, 움푹해진 캔, 녹슬거나 움푹해진 캔, 냉동제품 녹음, 냉동제품이 녹아 있다면 구입하지 않도록, 비살균 우유·주스, 비살균 쥬스, 비살균 요구르트",
        sourceIds: ["nccImmuneLowDiet"],
      },
    ],
  },
