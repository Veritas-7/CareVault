  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 가공육 섭취를 제한하고 햄, 베이컨, 소시지 등의 가공육은 되도록 피하도록 안내합니다. 또한 탄 음식을 피하며, 짠 음식은 피하고 싱겁게 먹고, 하루 한두 잔의 음주도 피하도록 안내합니다.",
        examples:
          "햄, 베이컨, 소시지 등의 가공육은 되도록 피합니다., 치료 후 가공육 제한, 치료 후 탄 음식 피하기, 치료 후 짠 음식 피하기, 치료 후 하루 한 두 잔 술도 피하기",
        sourceIds: ["nccAfterTreatmentHealthyEating"],
      },
      {
        label: "붉은 육류 적정량",
