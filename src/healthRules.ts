...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "채소·과일·통곡물·콩류",
        detail:
          "국가암정보센터 건강한 식생활 자료는 생채소·나물·샐러드·쌈류 등 채소류를 매일 매끼니 충분히 먹고, 과일류를 매일 1회 이상 간식으로 먹으며, 잡곡·도정하지 않은 곡류, 두류와 두유·두부 같은 두류 가공품, 하루 1잔 정도의 저지방 우유를 권하고 김치류는 짜지 않게 만들도록 안내합니다.",
        examples:
          "채소류, 생채소, 나물, 샐러드, 쌈류, 매끼니 채소, 매일 채소, 매일 매끼니 충분히, 채소 반찬, 매일 1회 이상 과일, 과일 매일 1회 이상, 과일 간식, 매일 과일 간식, 저염 김치, 짜지 않은 김치, 싱겁게 만든 김치, 짜지 않은 김치류, 제철 과일, 잡곡밥, 도정하지 않은 곡류, 현미, 귀리, 통밀빵, 두류, 두류 가공품, 두유, 두부, 하루 1잔 저지방 우유, 저지방 우유",
