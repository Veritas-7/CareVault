...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "채소류, 생채소, 나물, 샐러드, 쌈류, 매끼니 채소, 매일 채소, 매일 매끼니 충분히, 채소 반찬, 매일 1회 이상 과일, 과일 매일 1회 이상, 과일 간식, 매일 과일 간식, 저염 김치, 짜지 않은 김치, 싱겁게 만든 김치, 짜지 않은 김치류, 제철 과일, 잡곡밥, 도정하지 않은 곡류, 현미, 귀리, 통밀빵, 두류 매일 섭취, 두류 가공품 매일 섭취, 두유 두부 매일 섭취, 두류, 두류 가공품, 두유, 두부, 하루 1잔 저지방 우유, 저지방 우유",
