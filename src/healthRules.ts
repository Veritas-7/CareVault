  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 체중변화 자료는 체중증가 원인을 먼저 의사와 확인하도록 하며, 항암제 관련 수분 보유가 의심되면 가공식품·김치·젓갈·장아찌류 같은 염분 함량이 높은 식품을 제한하고, 식욕 증가가 있으면 청량 음료·초콜릿·사탕·과자류처럼 열량이 높고 영양가가 낮은 식품을 제한하도록 안내합니다. 체중조절 방법으로 버터, 마요네즈, 감미료 등을 추가로 사용하지 않도록 안내합니다.",
        examples:
          "버터, 마요네즈, 감미료 등을 추가로 사용하지 않도록 합니다.; 체중증가 가공식품, 체중증가 김치, 체중증가 젓갈, 체중증가 장아찌류, 체중증가 청량 음료, 체중증가 초콜릿, 체중증가 사탕, 체중증가 과자류, 체중증가 고열량 간식",
        sourceIds: ["nccWeightChangeDiet"],
      },
      {
        label: "가당 유제품",
