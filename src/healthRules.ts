...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 체중변화 자료는 치료과정에서 체중감소가 환자를 허약하게 만들고 암에 대한 저항력과 치료효과 등을 떨어뜨릴 수 있어, 체중감소 예방을 위해 열량과 단백질을 충분히 섭취하도록 안내합니다. 밥·죽을 다양하게 조리하고 야채죽·전복죽·계란죽·닭죽·깨죽·호박죽·단팥죽·잣죽 예시, 감자·고구마·떡·만두·과일주스·과일통조림 같은 간식과 탄수화물이 많이 포함된 간식, 계란·콩·두부·생선·유제품 단백질 예시, 단백질이 많이 포함된 간식 선택과 만두·피자·샌드위치·계란샐러드·카스테라 예시를 제시합니다.",
        examples:
          "암환자는 치료과정에서 체중의 감소를 흔하게 경험할 수 있습니다. 체중감소는 환자를 허약하게 만들고 암에 대한 저항력과 치료효과 등을 떨어뜨립니다. 그러므로 체중감소를 예방하기 위해서 열량과 단백질 등을 충분히 섭취해야 합니다.; 죽 : 야채죽, 전복죽, 계란죽, 닭죽, 깨죽, 호박죽, 단팥죽, 잣죽 등; 지방보다는 탄수화물이 많이 포함된 간식을 드시면 포만감이 빨리 사라지므로 더 편안함을 느낄 수 있다.; 간식으로 고기나 생선, 치즈, 계란, 우유 등이 많이 포함된 음식을 선택한다.; 만두, 피자, 샌드위치, 계란샐러드, 카스테라 등; 체중감소 김밥, 체중감소 주먹밥, 체중감소 야채죽, 체중감소 전복죽, 체중감소 계란죽, 체중감소 잣죽, 체중감소 감자, 체중감소 고구마, 체중감소 떡, 체중감소 만두, 체중감소 과일주스, 체중감소 과일통조림, 체중감소 땅콩버터, 체중감소 계란찜, 체중감소 두유, 체중감소 두부조림, 체중감소 생선전, 체중감소 어묵, 체중감소 요구르트",
