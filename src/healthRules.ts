  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "식품안전나라는 클로스트리디움 보툴리늄균을 그람양성의 편성혐기성 간균이며 세포 한쪽 끝에 난 원형의 아포를 형성하는 균으로 설명합니다. A형, B형, E형, 및 F형균이 사람에게 식중독을 일으키고, 독소는 매우 독성이 강하지만 열에 불안정하여 80℃, 20분과 100℃, 1~2분 가열로 파괴된다고 설명하므로 식품 안전 질문으로 분리합니다. 원인식품으로 통조림, 병조림, 레토르트 식품, 식육, 소시지 생선을 제시하고, 통조림, 햄, 소시지, 육제품 소비가 많은 곳에서는 A형, B형 균에 의한 식중독이 많다고 설명합니다. 환경조건이 혐기적일 때 아포가 발아하여 증식하면서 식중독을 발생시킬 정도의 독소를 생산할 수 있다고 설명합니다. 예방대책으로 채소와 곡물 세척, 신선한 어류 조리, 통조림·병조림 및 기타 저장식품도 반드시 가열 후 섭취하도록 안내합니다.",
        examples:
          "클로스트리디움 보툴리늄균, 그람양성의 편성혐기성 간균, 세포 한쪽 끝에 난 원형의 아포, A형, B형, E형, 및 F형균, 80℃, 20분과 100℃, 1~2분 가열로 파괴, 통조림, 병조림, 레토르트 식품, 식육, 소시지 생선, 통조림, 햄, 소시지, 육제품, 환경조건이 혐기적일 때 아포가 발아하여 증식하면서 식중독을 발생시킬 정도의 독소를 생산, 채소와 곡물을 반드시 깨끗이 세척하고 생선 등 어류는 신선한 것으로 조리해야 한다, 통조림·병조림 및 기타 저장식품도 반드시 가열 후 섭취하여야 한다",
