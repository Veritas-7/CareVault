  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 조혈모세포이식 자료는 `면역억제 시 제한하는 식품과 허용하는 식품` 표를 제시합니다. 제한 식품 예시에는 살균처리되지 않은 생우유, 아이스크림, 유산균발효유, 천연치즈, 생과일, 냉동과일, 마른과일, 생채소, 끓이지 않은 물, 핫칠리소스, 후추, 생된장, 허브, 생꿀, 포장되지 않은 제빵류, 익히지 않은 어육류(생선회, 육회), 껍질에 금이 간 계란, 조개류, 오징어, 훈제연어, 젓갈, 내장류, 숙성치즈, 효모 건강보조식품 등이 있고, 허용 식품 예시에는 멸균우유, 멸균두유, 과일 통조림, 캔쥬스, 완전히 익힌 채소류, 식용유, 버터, 마가린, 포장된 제빵류, 완전히 익힌 어육류 및 난류, 두부, 완전히 익힌 육가공품, 마요네즈, 멸균 처리된 상업용 포장꿀, 캔으로 판매되는 음료 등이 있습니다. 이 항목은 조혈모세포이식이나 면역억제 상황의 식품표 확인으로만 사용하고, 전체 환자 식단 규칙이나 치료식 주장으로 과장하지 않습니다.",
        examples:
          "면역억제 시 제한하는 식품과 허용하는 식품, 면역억제 생과일, 면역억제 생채소, 면역억제 끓이지 않은 물, 면역억제 생꿀, 면역억제 천연치즈, 면역억제 살균처리되지 않은 생우유, 면역억제 아이스크림, 면역억제 유산균발효유, 면역억제 냉동과일, 면역억제 마른과일, 면역억제 핫칠리소스, 면역억제 후추, 면역억제 생된장, 면역억제 허브, 면역억제 포장되지 않은 제빵류, 면역억제 생선회, 면역억제 육회, 면역억제 껍질에 금이 간 계란, 면역억제 조개류, 면역억제 오징어, 면역억제 훈제연어, 면역억제 젓갈, 면역억제 내장류, 면역억제 숙성치즈, 면역억제 효모 건강보조식품, 면역억제 멸균우유, 면역억제 멸균두유, 면역억제 과일 통조림, 면역억제 완전히 익힌 채소류, 면역억제 캔쥬스, 면역억제 식용유, 면역억제 버터, 면역억제 마가린, 면역억제 포장된 제빵류, 면역억제 완전히 익힌 어육류, 면역억제 완전히 익힌 난류, 면역억제 두부, 면역억제 완전히 익힌 육가공품, 면역억제 마요네즈, 면역억제 멸균 처리된 상업용 포장꿀, 면역억제 캔으로 판매되는 음료",
