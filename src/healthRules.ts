  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "식품안전나라는 병원성 대장균 중 베로독소를 생성해 대장점막에 궤양과 출혈을 유발하는 대장균을 장관출혈성대장균이라고 설명하며, O26, O103, O104, O146, O157 등 혈청형과 대표 균인 대장균 O157:H7을 제시합니다. 주요 증상은 설사, 복통, 발열, 구토이고 심하면 출혈성 대장염, 용혈성요독증후군, 혈전성혈소판 감소증 등이 나타날 수 있으므로 식품 안전 질문으로 분리합니다. 주요 원인식품으로 햄, 치즈, 소시지, 채소샐러드, 분유, 두부, 음료수, 어패류, 도시락, 급식 등을 제시합니다. 감염원 및 감염경로 문맥으로 자연계에서는 하천수와 어패류 등에서 분리 검출되므로 1차 및 2차 오염으로 감염될 수 있다고 설명합니다. 예방대책으로 조리기구(칼, 도마 등) 구분 사용, 생육과 조리된 음식을 구분하여 보관, 다진 고기는 중심부 온도가 75℃ 1분 이상 가열을 안내합니다.",
        examples:
