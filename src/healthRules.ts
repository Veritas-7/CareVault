  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "소금이 우리 몸에서 수분을 축적시키는 작용을 하므로 염분 함량이 높은 식품(예: 가공식품, 김치, 젓갈, 장아찌류 등)은 제한하고 가능한 싱겁게 먹는 것이 좋습니다.; 버터, 마요네즈, 감미료 등을 추가로 사용하지 않도록 합니다.; 가능한 고열량의 간식은 먹지 않도록 합니다.; 체중증가 가공식품, 체중증가 김치, 체중증가 젓갈, 체중증가 장아찌류, 체중증가 청량 음료, 체중증가 초콜릿, 체중증가 사탕, 체중증가 과자류, 체중증가 고열량 간식",
        sourceIds: ["nccWeightChangeDiet"],
      },
      {
        label: "가당 유제품",
