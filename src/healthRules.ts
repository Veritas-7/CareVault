  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "가공육·탄 음식·튀김",
        detail:
          "국가암정보센터 암예방 식단 예시는 햄·소시지 등 가공육류를 가급적 적게 섭취하고 직화 구이와 튀김 조리법을 피하도록 안내하며, 건강한 식생활 자료도 햄·소시지 등 육가공품을 가급적 먹지 않기, 탄 음식은 먹지 않기, 숯불로 굽거나 직접 구워 탄 음식 섭취 삼가기, 지방 함량이 많은 육류 부위 제한을 안내합니다.",
        examples:
          "햄, 소시지, 가공육류, 가공육, 육가공품, 햄·소시지, 햄 소시지, 햄 소시지 육가공품, 육가공품 가급적 먹지 않기, 육가공품 가급적 먹지 않습니다, 베이컨, 탄 고기, 숯불구이, 숯불 직화, 직접 구이, 직접구이, 탄 음식은 먹지 않기, 탄 음식은 먹지 않습니다, 숯불로 구운 탄 음식, 직접 구워 탄 음식, 탄 음식 섭취 삼가, 지방 함량이 많은 부위, 직화 구이, 직화구이, 튀김 조리, 튀긴 음식, 튀김",
