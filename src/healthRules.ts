...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "치료 후 균형식·전곡류",
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 암에 대한 모든 치료들이 끝난 후에는 건강한 식생활을 위한 식사지침을 따르도록 합니다. 곡류·단백질 식품·채소류를 포함한 균형 잡힌 식사, 우유 및 유제품류와 과일류, 다양한 색의 과일·채소·전곡류를 충분히 먹는 방향을 안내합니다.",
        examples:
          "암에 대한 모든 치료들이 끝난 후에는 건강한 식생활을 위한 식사지침을 따르도록 합니다., 치료 후 건강한 식생활, 치료 후 다채로운 식단과 균형잡힌 식사, 치료 후 다양한 단백질 식품과 채소류, 치료 후 우유 및 유제품류 과일류, 치료 후 과일 채소 전곡류 충분히",
