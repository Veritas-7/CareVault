...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "암예방 식단 예시",
        detail:
          "국가암정보센터 암예방 식단 예시는 매 식사에 채소 반찬(생채·샐러드·나물·쌈 등) 2가지 이상, 다양한 색의 신선한 채소와 제철 식품, 다양한 잡곡이 섞인 밥, 생선·달걀·콩·닭고기 단백질 식품, 등푸른 생선 주 2회 이상, 간편식의 통밀·귀리 등 통곡물 빵과 샐러드·저지방 유제품·매일 과일 예시, 단체 급식의 다양한 채소 반찬과 적정량 단백질 예시를 균형식 후보로 제시합니다.",
        examples:
          "채소 반찬, 생채, 나물, 채소 쌈, 신선한 채소, 다양한 색의 채소, 제철 식품, 다양한 잡곡, 잡곡, 아욱된장국, 호박나물, 콩나물무침, 고등어구이, 생선, 달걀, 콩, 닭고기, 등푸른 생선, 고등어, 통밀빵, 통밀 식빵, 통밀, 귀리빵, 귀리 식빵, 귀리, 샐러드(채소), 샐러드(달걀), 샐러드(치즈), 모차렐라, 리코타 치즈, 플레인 요구르트, 플레인 요거트, 저지방 유제품, 저지방 요구르트, 저지방 요거트, 방울토마토, 블루베리, 과일류, 매일 과일, 미역국, 상추쌈, 버섯나물, 불고기",
