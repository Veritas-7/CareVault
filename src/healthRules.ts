...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "치료 후 균형식·전곡류",
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 암에 대한 모든 치료들이 끝난 후에는 건강한 식생활을 위한 식사지침을 따르도록 합니다. 우리 몸에 필요한 영양소는 다양한 식품과 음식을 통하여 섭취해야 한다고 설명하며, 균형잡힌 식사란 나에게 맞는 적당량으로, 매끼 적당량의 곡류와 고기, 생선, 계란, 두부 등의 다양한 단백질 식품을 1~2가지, 2~3가지의 채소류를 포함한 식사를 하고 우유 및 유제품류, 과일류를 하루 1~2회 간식으로 섭취하는 것이라고 안내합니다. 또한 다양한 색의 과일, 채소와 전곡류를 충분하게 먹도록 안내합니다.",
        examples:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 가공육 섭취를 제한하고 햄, 베이컨, 소시지 등의 가공육은 되도록 피하도록 안내합니다. 또한 육류는 적정량으로 살코기 위주로 섭취하며, 조리 시 직화구이를 피하고 탄 음식을 먹지 않도록 안내합니다. 짠 음식의 섭취를 피하고 싱겁게 먹으며, 음식을 만들 때는 소금, 간장 등 짠맛이 나는 양념의 사용을 줄이고 싱겁게 조리하도록 안내합니다. 국이나 찌개는 건더기 위주로 섭취하고 김치, 젓갈, 장아찌, 피클 등 염장 식품의 섭취를 줄이도록 안내합니다. 하루 한 두 잔의 술도 피하도록 안내합니다.",
        examples:
          "햄, 베이컨, 소시지 등의 가공육은 되도록 피합니다., 육류는 적정량 (탁구공 1~2개 크기)으로 살코기 위주로 섭취하며, 조리 시 직화구이를 피하고 탄 음식을 먹지 않습니다., 짠 음식의 섭취를 피하고, 싱겁게 먹습니다., 음식을 만들 때는 소금, 간장 등 짠맛이 나는 양념의 사용을 줄이고, 싱겁게 조리합니다., 국이나 찌개 섭취 시에는 건더기 위주로 섭취하며, 김치, 젓갈, 장아찌, 피클 등 염장 식품의 섭취를 줄입니다., 하루 한 두 잔의 술도 피합니다., 치료 후 가공육 제한, 치료 후 탄 음식 피하기, 치료 후 짠 음식 피하기, 치료 후 하루 한 두 잔 술도 피하기",
        sourceIds: ["nccAfterTreatmentHealthyEating"],
      },
      {
        label: "붉은 육류 적정량",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 후 건강한 식생활 자료는 어떤 특정 식품이나 음식에 의해 암의 재발을 막는다는 연구보고는 없다고 설명합니다. 또한 시중에 암 예방 효과가 있다고 알려진 여러 식품들이나 건강 보조식품들은 아직 안정성이나 효과에 대해 과학적으로 입증된 근거가 없으므로 선택 시 주의가 필요하다고 안내합니다. 치료 후 부작용 등으로 적절한 식사 섭취가 힘들거나 고혈압·당뇨병·고지혈증 등으로 식사조절이 필요하면 담당의사 및 임상영양사와 상담하도록 안내합니다.",
        examples:
          "어떤 특정 식품이나 음식에 의해 암의 재발을 막는다는 연구보고는 없습니다., 시중에 암 예방 효과가 있다고 알려진 여러 식품들이나 건강 보조식품들은 아직 안정성이나 효과에 대해 과학적으로 입증된 근거가 없으므로 선택 시 주의가 필요합니다., 치료 후 부작용으로 식사 섭취 힘듦, 치료 후 건강보조식품 민간요법 주의",
        sourceIds: ["nccAfterTreatmentHealthyEating"],
      },
      {
