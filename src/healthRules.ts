  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "짠 저장식품·국물 과다",
        detail:
          "암예방 식생활 자료는 인공조미료(화학조미료 포함)의 사용을 제한하며 음식을 싱겁게 만들어 먹기, 음식을 먹을 때 추가로 소금이나 간장을 사용하지 않기, 염장식품 제한, 국이나 찌개 국물 제한을 안내하며, 예시 식단의 배추김치·열무김치도 나트륨을 줄이기 위해 조금만 섭취하는 항목으로 설명합니다.",
        examples:
          "인공조미료(화학조미료 포함)의 사용을 제한하며 음식을 싱겁게 만들어 먹습니다, 인공조미료 화학조미료 사용 제한 싱겁게 만들어 먹기, 인공조미료, 화학조미료, 음식을 먹을 때 추가로 소금이나 간장을 사용하지 않습니다, 소금이나 간장 사용하지 않기, 추가 소금, 추가 간장, 젓갈류, 염 저장식품, 소금 저장식품, 김치 또는 장아찌류, 젓갈, 장아찌, 염장식품, 짠 김치, 배추김치, 열무김치, 국이나 찌개의 국물, 찌개 국물, 국물 섭취, 국물 과다",
