...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "건강식이란 균형 잡힌 식사를 말합니다. 즉, 다양한 음식을 골고루 먹는 것입니다. 그래야 충분한 열량과 단백질, 비타민과 무기질을 섭취하여 좋은 영양 상태를 유지할 수 있습니다., 치료 중 적정 열량과 필수 영양소, 치료 중 충분한 열량 단백질 비타민 무기질, 고칼로리, 고단백질의 식품을 비롯한 다양한 음식을 골고루 섭취하는 것이 도움이 됩니다, 치료 중 고칼로리 고단백질 음식, 치료 중 좋아하는 음식과 여러 식품, 치료 중 다양한 음식 골고루",
        sourceIds: ["nccTreatmentRightEating"],
      },
      {
        label: "치료 중 탄수화물·단백질·수분",
        detail:
          "치료 중 영양 자료는 탄수화물, 단백질, 지방, 비타민·무기질, 물을 기본 영양소로 설명하고, 감자·고구마·옥수수 같은 탄수화물 식품, 쇠고기·돼지고기·닭고기 등 육류와 생선류·조개류·달걀·두부·우유 같은 단백질 식품, 참기름·들기름·콩기름·버터 같은 지방 식품, 채소와 과일의 비타민·무기질, 성인 하루 물 6~8컵을 예시로 안내합니다. 건강한 식생활 자료는 육류 섭취 시 구워 먹기보다는 삶거나 끓인 조리 예시를 제시하며, 면역저하 자료는 음식으로 인한 감염 예방을 위해 완전히 익힌 음식과 쥬스·우유·요구르트 등 저온살균 제품을 선택하도록 안내합니다.",
        examples:
          "감자, 고구마, 옥수수, 물 6~8컵, 하루 6~8컵 물, 치료 중 단백질 식품, 치료 중 육류와 생선류, 치료 중 조개류, 치료 중 달걀 두부 우유, 치료 중 참기름 들기름 콩기름 버터, 치료 중 채소와 과일, 육류 섭취 시 이를 구워 먹기(숯불구이, 직접 구이 등)보다는 삶거나 끓여서(수육, 보쌈 등) 먹습니다, 육류 구워 먹기보다는 삶거나 끓여서 수육 보쌈 먹기, 완전히 익힌 음식, 저온살균 우유, 저온살균 주스, 저온살균 제품, 저온살균 요구르트, 유통기한 확인, 냉장고에서 해동, 익힌 생선·닭고기·달걀, 수육, 보쌈, 고등어, 두부, 저지방 우유, 플레인 요구르트, 물",
      ...
      },
      {
        ...
        detail:
          "국가암정보센터 치료 중 건강식을 먹는 요령 자료는 식사가 치료의 보조 요법만큼 중요하다고 설명하며, 규칙적인 아침·점심·저녁 식사, 밥 반 그릇에서 한 그릇 또는 죽 하루 4~5번 이상, 끼니마다 충분한 단백질 반찬, 매끼 두 가지 이상 채소 반찬, 씹거나 삼키기 힘든 경우 다지거나 갈아서 먹기, 과일 하루 한두 번, 우유와 유제품 하루 1컵 이상과 요구르트·두유·치즈 대체, 식용유·참기름·버터 등 기름을 볶음이나 나물 요리 양념으로 쓰는 방법, 양념과 조미료를 적당히 쓰되 너무 맵거나 짜지 않게 요리하는 방법을 안내합니다.",
        examples:
          "규칙적으로 아침, 점심, 저녁 식사를 하며, 반찬을 골고루 먹습니다., 밥은 매끼 반 그릇에서 한 그릇 정도 먹고, 간식으로 빵 종류와 크래커, 떡 등을 조금씩 먹습니다. 죽을 먹어야 하는 경우에는 하루 4~5번 이상 자주 드는 것이 좋습니다., 끼니마다 고기나 생선, 달걀, 두부, 콩, 치즈 등 단백질 반찬을 충분히 곁들입니다., 채소 반찬은 매끼 두 가지 이상을 충분히 먹습니다., 씹거나 삼키기 힘든 경우에는 다지거나 갈아서 먹습니다., 한 가지 이상의 과일을 하루에 한두 번 정도 먹는 것이 좋습니다., 우유와 유제품은 하루 1컵(200ml) 이상 마십니다., 우유가 맞지 않을 경우엔 요구르트, 두유, 치즈 따위를 대신 먹습니다., 식용유, 참기름, 버터 등의 기름은 볶음이나 나물 요리에 양념으로 사용합니다., 양념과 조미료를 적당히 사용하되 너무 맵거나 짜지 않게 요리합니다., 치료 중 규칙적인 아침 점심 저녁, 치료 중 밥 반 그릇에서 한 그릇, 치료 중 죽 하루 4~5번 이상, 치료 중 단백질 반찬 충분히, 치료 중 채소 반찬 매끼 두 가지 이상, 치료 중 과일 하루 한두 번, 치료 중 우유와 유제품 하루 1컵, 치료 중 요구르트 두유 치즈",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        examples:
          "몸에 좋다고 소문난 식품, 몸에 좋다고 소문난 영양소, 암환자가 몸에 좋다는 특정 식품이나 영양소를 편중해서 섭취하면 일부 영양소는 과잉 상태가 되고 다른 중요한 영양소와 전체 열량은 부족한 상태가 되어 당초 의도와 달리 환자에게 나쁜 영향을 줄 수 있습니다, 특정 식품이나 영양소 편중, 백혈구 수치를 올리는 특별한 음식은 없습니다, 백혈구 수치를 올리는 특별한 음식",
        sourceIds: ["nccTreatmentRightEating"],
      },
      {
        label: "치료 중 식사 고민·영양 상담",
        detail:
          "국가암정보센터 치료 중 올바르게 식사하기 자료는 암환자의 식사와 관련한 고민이 있다면 의료진, 영양사와 상담하고 적절한 영양 섭취에 관해 상담을 받도록 안내합니다.",
        examples:
          "암환자의 식사와 관련하여 고민이 있다면 의료진, 영양사와 상담하십시오. 적절한 영양 섭취에 관해 상담을 해드릴 것입니다., 치료 중 식사 고민 의료진 영양사 상담",
        sourceIds: ["nccTreatmentRightEating"],
      },
      {
