...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "실천지침 식단 예시",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침은 채소·과일을 충분히 섭취하고 짠 음식과 탄 음식을 제한하는 식단 예시를 제시합니다. 예시 식단은 채소샐러드에 요플레드레싱을 사용해 채소 섭취량을 늘리고, 북어콩나물국과 쇠고기뭇국의 소금·간장 사용을 줄이며, 우엉조림을 우엉볶음으로 바꾸어 나트륨 섭취를 줄이는 조리 예시도 함께 보여줍니다.",
        examples:
          "잡곡밥, 과일샐러드, 채소샐러드, 채소 섭취량 증가(채소샐러드는 요플레드레싱 사용), 브로콜리회, 귤, 딸기 요플레, 북어콩나물국, 소금 및 간장 사용량 감소(소금 섭취량 감소), 시금치나물, 우엉볶음, 우엉조림 → 우엉볶음 : 간장 사용량 감소(소금 섭취량 감소), 쇠고기뭇국, 소금 대신 간장 사용으로 나트륨 섭취량 감소",
