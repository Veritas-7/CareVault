...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "실천지침 식단 예시",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침은 채소·과일을 충분히 섭취하고 짠 음식과 탄 음식을 제한하는 식단 예시를 제시합니다. 식단 작성 시 다양한 종류의 식품을 섭취할 수 있도록 계획하고, 파프리카·피망·시금치·토마토·당근·양배추처럼 식품이 지닌 색상을 고려해 다양한 색상이 포함되도록 식품을 선택하라고 안내합니다. 규칙적인 식생활과 즐거운 마음의 식사도 함께 권합니다. 예시 식단은 채소샐러드에 요플레드레싱을 사용해 채소 섭취량을 늘리고, 북어콩나물국과 쇠고기뭇국의 소금·간장 사용을 줄이며, 우엉조림을 우엉볶음으로 바꾸어 나트륨 섭취를 줄이는 조리 예시도 함께 보여줍니다.",
        examples:
          "식단 작성 시 다양한 종류의 식품을 섭취할 수 있도록 계획해 보십시오., 파프리카, 피망, 시금치, 토마토, 당근, 양배추 등 식품이 지닌 색상을 고려하여 다양한 종류의 색상이 포함되도록 식품을 선택해 보십시오., 건강을 생각해서 규칙적인 식생활과 더불어 즐거운 마음으로 식사를 하시기 바랍니다., 파프리카, 피망, 토마토, 잡곡밥, 과일샐러드, 채소샐러드, 채소 섭취량 증가(채소샐러드는 요플레드레싱 사용), 브로콜리회, 귤, 딸기 요플레, 북어콩나물국, 소금 및 간장 사용량 감소(소금 섭취량 감소), 시금치나물, 우엉볶음, 우엉조림 → 우엉볶음 : 간장 사용량 감소(소금 섭취량 감소), 쇠고기뭇국, 소금 대신 간장 사용으로 나트륨 섭취량 감소",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "실천지침 대체 식단 예시",
        detail:
          "국민 암예방 수칙 자궁경부암 실천지침의 예시 식단은 식이섬유를 늘리는 잡곡밥 대체 예시와 함께 가공육·달콤한 간식·짠 반찬·국물 과다와 나트륨이 많은 조림을 줄이고 과일·채소·저염 조리 예시로 바꾸는 방향을 보여주며, 국 또는 찌개의 국물은 다 먹지 않도록 안내합니다. 식생활 습관 개선은 한꺼번에 바꾸지 않고 가능한 것부터 확인해 서서히 단계적으로 계획하며, 지방 함량이 높은 식품이나 짠 음식 섭취를 줄이고 신선한 채소·과일·곡류를 자주 먹으며, 가능한 제철 과일·채소를 구입하고 곰팡이 핀 음식은 피하라고 안내합니다.",
        examples:
          "쌀밥, 흰쌀밥, 햄구이, 초코칩쿠키, 단무지, 우엉조림, 국·찌개 국물, 국물 과다, 국 또는 찌개의 국물은 다 드시지 마십시오., 한꺼번에 식생활 습관을 바꾸는 것은 위험합니다. 다음의 내용을 숙지하면서 식생활 개선을 시작하세요., 식생활을 한꺼번에 바꾸려고 하지 말고 내가 할 수 있는 것들을 확인하여 서서히 단계적으로 변화시킬 수 있는 계획표를 작성해 보십시오., 가능한 지방 함량이 높은 식품이나 짠 음식 섭취를 줄이겠다는 생각을 가지며, 신선한 채소와 과일, 곡류 등을 자주 드시기 바랍니다., 가능한 제철 과일, 채소를 구입하십시오. 곰팡이 핀 음식은 피하시기 바랍니다.",
        sourceIds: ["nccCervicalPracticeDiet"],
      },
      {
