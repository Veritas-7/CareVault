...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "채소·과일·통곡물·콩류",
        detail:
          "국가암정보센터 건강한 식생활 자료는 채소류(생채소, 나물, 샐러드, 쌈류 등)를 매일, 매끼니 충분히 먹고, 과일류는 매일 1회 이상 간식으로 섭취하며, 다양한 종류의 잡곡과 도정하지 않은 곡류를 섭취하고, 두류와 두류 가공품(두유, 두부 등)을 매일 섭취하며, 하루 1잔 정도의 저지방 우유를 권하고 김치류는 짜지 않게 만들어 먹도록 안내합니다.",
        examples:
          "채소류(생채소, 나물, 샐러드, 쌈류 등)를 매일, 매끼니 충분히 먹습니다, 채소류 생채소 나물 샐러드 쌈류 매일 매끼니 충분히, 채소류, 생채소, 나물, 샐러드, 쌈류, 매끼니 채소, 매일 채소, 매일 매끼니 충분히, 채소 반찬, 과일류는 매일 1회 이상 간식으로 섭취합니다, 과일류 매일 1회 이상 간식 섭취, 매일 1회 이상 과일, 과일 매일 1회 이상, 과일 간식, 매일 과일 간식, 다양한 종류의 잡곡과 도정하지 않은 곡류를 섭취합니다, 잡곡 도정하지 않은 곡류 섭취, 두류와 두류 가공품 (두유, 두부 등)을 매일 섭취합니다, 두류 두류 가공품 두유 두부 매일 섭취, 저염 김치, 김치류는 짜지 않게 만들어 먹습니다, 김치류 짜지 않게 만들기, 짜지 않은 김치, 싱겁게 만든 김치, 짜지 않은 김치류, 제철 과일, 잡곡밥, 도정하지 않은 곡류, 현미, 귀리, 통밀빵, 두류 매일 섭취, 두류 가공품 매일 섭취, 두유 두부 매일 섭취, 두류, 두류 가공품, 두유, 두부, 저지방 우유 하루 1잔 정도, 하루 1잔 정도 저지방 우유, 하루 1잔 저지방 우유, 저지방 우유",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "짠 저장식품·국물 과다",
        detail:
          "암예방 식생활 자료는 인공조미료(화학조미료 포함)의 사용을 제한하며 음식을 싱겁게 만들어 먹기, 음식을 먹을 때 추가로 소금이나 간장을 사용하지 않기, 젓갈류와 염(소금) 저장식품(김치 또는 장아찌류 등) 섭취 제한, 국이나 찌개 국물 제한을 안내하며, 예시 식단의 배추김치·열무김치도 나트륨을 줄이기 위해 조금만 섭취하는 항목으로 설명합니다.",
        examples:
          "인공조미료(화학조미료 포함)의 사용을 제한하며 음식을 싱겁게 만들어 먹습니다, 인공조미료 화학조미료 사용 제한 싱겁게 만들어 먹기, 인공조미료, 화학조미료, 음식을 먹을 때 추가로 소금이나 간장을 사용하지 않습니다, 소금이나 간장 사용하지 않기, 추가 소금, 추가 간장, 젓갈류와 염(소금) 저장식품(김치 또는 장아찌류 등)의 섭취는 제한합니다, 젓갈류 염 소금 저장식품 김치 장아찌류 섭취 제한, 젓갈류, 염 저장식품, 소금 저장식품, 김치 또는 장아찌류, 젓갈, 장아찌, 염장식품, 짠 김치, 배추김치, 열무김치, 국이나 찌개의 국물, 찌개 국물, 국물 섭취, 국물 과다",
