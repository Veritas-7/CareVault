  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "식품안전나라는 클로스트리디움 퍼프린젠스균을 아포를 형성하는 그람양성 편성혐기성 간균으로 설명하고, 아포의 발아 시 독소를 생성하며 사람의 식중독에는 주로 A형과 C형이 관여한다고 설명합니다. 원인식품으로 돼지고기, 닭고기, 칠면조고기 등으로 조리한 식품 및 그 가공품인 동물성 단백질식품과 미리 가열 조리된 후 실온에서 5시간이상 방치된 식품을 제시하므로 식품 안전 질문으로 분리합니다. 감염원 및 감염경로로 물, 토양, 하수 등 자연계와 가축과 가금류의 장관에 상재할 수 있고 건강한 사람의 장관에도 존재한다고 설명하므로 퍼프린젠스 문맥의 경로 확인으로만 다룹니다. 예방대책으로 대량 큰 용기 보관은 혐기조건이 될 수 있어 소량씩 용기에 넣어 보관, 부득이하게 남은 음식은 먹기 전에 충분히 가열, 따뜻하게 배식하는 음식은 조리 후 배식까지 60℃ 이상 유지, 차갑게 배식하는 음식은 조리 후 재빨리 식혀 5℃ 이하에서 보관을 안내합니다.",
        examples:
          "클로스트리디움 퍼프린젠스균, 아포의 발아 시 독소를 생성, A형과 C형, 돼지고기, 닭고기, 칠면조고기 등으로 조리한 식품 및 그 가공품인 동물성 단백질식품, 미리 가열 조리된 후 실온에서 5시간이상 방치된 식품, 물, 토양, 하수 등 자연계, 가축과 가금류의 장관, 건강한 사람의 장관, 식품을 대량으로 큰 용기에 보관하면 혐기조건이 될 수 있으므로 소량씩 용기에 넣어 보관한다, 부득이하게 남은 음식은 먹기 전에 충분히 가열한 후 섭취하여야 한다, 따뜻하게 배식하는 음식은 조리 후 배식까지 60℃ 이상을 유지해야 하며, 차갑게 배식하는 음식은 조리 후 재빨리 식혀 5℃ 이하에서 보관한다",
