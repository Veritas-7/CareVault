...
export const cancerFoodGuideCategories: CancerFoodGuideCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "채소·과일·통곡물·콩류",
        detail:
          "국가암정보센터 건강한 식생활 자료는 채소류를 매일·매끼니 충분히 먹고, 매일 과일과 잡곡·도정하지 않은 곡류, 두류와 두유·두부 같은 두류 가공품, 하루 1잔 정도의 저지방 우유를 권합니다.",
        examples:
          "채소류, 매끼니 채소, 매일 채소, 채소 반찬, 제철 과일, 잡곡밥, 도정하지 않은 곡류, 현미, 귀리, 통밀빵, 두류, 두류 가공품, 두유, 두부, 하루 1잔 저지방 우유, 저지방 우유",
