...
2. PARTIAL: Search is local lexical/provenance/signal retrieval with snippets,
   ...
   handoff lines, visit-summary RAG evidence sections, CSV `document_rag_evidence`
   rows, and caregiver HTML RAG evidence sections. It is not vector RAG or
