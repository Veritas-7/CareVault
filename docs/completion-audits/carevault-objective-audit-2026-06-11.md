...
in-app source-grounded answer drafts, fail-closed model handoff prompts,
source-grounded care-brief lines,
...
not model-embedding or model-backed in-app generative RAG.
