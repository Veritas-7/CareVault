...
- 2026-06-07: Made caregiver-share vital fingerprints ignore old normal vital note changes outside the recent-vital and care-queue-rendered vital scope.
- 2026-06-07: Made caregiver-share symptom fingerprints ignore old low-risk symptoms and hidden old queue-symptom body text outside the recent-symptom and care-queue-rendered action scope, while still tracking old high-risk action changes.
- 2026-06-07: Made caregiver-share vital fingerprints ignore optional fields outside the rendered vital type while still tracking visible blood-pressure, glucose, temperature, note, assessment, and source output.
- 2026-06-07: Made caregiver-share question and lab fingerprints ignore internal record ids while still tracking rendered fields.
- 2026-06-07: Made backup export/import sanitizer mark every attachment filename as filename-only reattachment-needed state, even when the backup did not include a local path.
- 2026-06-07: Made CSV and visit-summary preview fingerprints ignore internal record ids while still tracking exported record fields.
