...
- export preview controls for Markdown, CSV, and caregiver HTML before download, including copy-to-clipboard
...
The next durable app slice should add print actions inside the export preview panel.
