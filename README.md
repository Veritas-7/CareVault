...
- print-friendly read-only caregiver HTML export with lab/food source labels and no local file paths
...
The next durable app slice should add caregiver-share section include options.
