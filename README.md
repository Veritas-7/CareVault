...
- print-friendly read-only caregiver HTML export with profile redaction, section include options, lab/food source labels, and no local file paths
...
The next durable app slice should add a caregiver-share cover memo.
