...
- export preview controls for Markdown, CSV, and caregiver HTML before download
...
The next durable app slice should add copy or print actions inside the export preview panel.
